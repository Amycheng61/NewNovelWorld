...
if(!token){
    ...
    $(".user_link").html("<i class=\"line mr20\">|</i><a href=\"/user/login.html\"  class=\"mr15\">Login</a><a href=\"/user/register.html\" >SignIn</a>");
}else{
    $.ajax({
        type: "POST",
        ...
        success: function(data){
            if(data.code == 200){
                ...
                $(".user_link").html("<i class=\"line mr20\">|</i><a href=\"/user/login.html\"  class=\"mr15\">Login</a><a href=\"/user/register.html\" >Sign In</a>");
            }
        },
        error: function () {
            layer.alert('网络异常');
...
String.prototype.isPhone = function () {
    var strTemp = /\+(9[976]\d|8[987530]\d|6[987]\d|5[90]\d|42\d|3[875]\d|2[98654321]\d|9[8543210]|8[6421]|6[6543210]|5[87654321]|4[987654310]|3[9643210]|2[70]|7|1)\d{1,14}$/;
