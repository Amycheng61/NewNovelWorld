...
public class OrderServiceImpl implements OrderService {
    ...
    @SneakyThrows
    @Override
    public Long createPayOrder(Byte payChannel, Integer payAmount,Byte memberType, Long userId) {
        ...
        orderPay.setMemberType(memberType);
    ...
    public void updatePayOrder(Long outTradeNo, String tradeNo, String tradeStatus) {
        SelectStatementProvider selectStatement = select(OrderPayDynamicSqlSupport.id, OrderPayDynamicSqlSupport.payStatus, OrderPayDynamicSqlSupport.memberType, OrderPayDynamicSqlSupport.totalAmount, OrderPayDynamicSqlSupport.userId)
        ...
        log.info("-------getPayStatus:" + orderPay.getPayStatus() + "tradeStatus:" + tradeStatus + "-------");
        if (orderPay.getPayStatus() != 1) {
            ...
            if (tradeStatus.equals("TRADE_SUCCESS") || tradeStatus.equals("TRADE_FINISHED")) {
                ...
                //2.修改会员状态，会员有效时间时间，会员金额
                try {
                    userService.addAmount(orderPay.getUserId(), orderPay.getMemberType(), orderPay.getTotalAmount() * 100);
                }
