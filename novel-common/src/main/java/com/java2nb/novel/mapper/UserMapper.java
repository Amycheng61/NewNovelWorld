...
public interface UserMapper {
    ...
    BasicColumn[] selectList = BasicColumn.columnList(id, username, email, password, nickName, userPhoto, userSex, accountBalance, status, isMember, memberValidityTime, createTime, updateTime);
    ...
    @Results(id = "UserResult", value = {
            ...
            @Result(column = "is_member", property = "isMember", jdbcType = JdbcType.TINYINT),
            @Result(column = "member_validity_time", property = "memberValidityTime", jdbcType = JdbcType.TIMESTAMP),
    ...
    default int insert(User record) {
        return MyBatis3Utils.insert(this::insert, record, user, c ->
                c.map(id).toProperty("id")
                        ...
                        .map(memberValidityTime).toProperty("memberValidityTime")
    ...
    default int insertSelective(User record) {
        return MyBatis3Utils.insert(this::insert, record, user, c ->
                c.map(id).toPropertyWhenPresent("id", record::getId)
                        ...
                        .map(memberValidityTime).toPropertyWhenPresent("memberValidityTime", record::getMemberValidityTime)
    ...
    static UpdateDSL<UpdateModel> updateAllColumns(User record, UpdateDSL<UpdateModel> dsl) {
        return dsl.set(id).equalTo(record::getId)
                ...
                .set(memberValidityTime).equalTo(record::getMemberValidityTime)
    ...
    static UpdateDSL<UpdateModel> updateSelectiveColumns(User record, UpdateDSL<UpdateModel> dsl) {
        return dsl.set(id).equalToWhenPresent(record::getId)
                ...
                .set(memberValidityTime).equalToWhenPresent(record::getMemberValidityTime)
