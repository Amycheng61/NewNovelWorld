...
public final class UserDynamicSqlSupport {
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    public static final SqlColumn<Byte> isMember = user.isMember;

    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    public static final SqlColumn<Date> memberValidityTime = user.memberValidityTime;
    ...
    public static final class User extends SqlTable {
        ...
        public final SqlColumn<Byte> isMember = column("is_member", JDBCType.TINYINT);

        public final SqlColumn<Date> memberValidityTime = column("member_validity_time", JDBCType.TIMESTAMP);
