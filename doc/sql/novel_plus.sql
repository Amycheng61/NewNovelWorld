/*
 ...
 Source Schema         : novel_plus

 Target Server Type    : MySQL
 Target Server Version : 50727
 File Encoding         : 65001

 Date: 20/07/2023 17:26:41
*/
...
CREATE TABLE `author`  (
  ...
  `pen_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '笔名',
  `tel_phone` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '手机号码',
  `chat_account` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'QQ或微信账号',
  `email` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '电子邮箱',
  `work_direction` tinyint(4) NULL DEFAULT NULL COMMENT '作品方向，0：男频，1：女频',
  `status` tinyint(4) NULL DEFAULT 0 COMMENT '0：正常，1：封禁',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '作者表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of author
-- ----------------------------
INSERT INTO `author` VALUES (1, NULL, 'reerer', '梦入神机', '13560487656', '23484388', '23484388@qq.com', 0, 0, NULL);
INSERT INTO `author` VALUES (2, 1255060328322027520, 'rwrr445554', '天蚕土豆', '13560421324', '1179705413', 'reerer@qq.com', 0, 0, '2020-05-13 14:01:31');
INSERT INTO `author` VALUES (3, 1681866976364371968, '123456', '忘语', '15755581234', '9317', '9317@qq.com', 0, 0, '2023-07-20 11:24:01');
INSERT INTO `author` VALUES (4, 1681952053513478144, 'ww34343', '辰东', '15755581235', '931708', '931708@qq.com', 0, 0, '2023-07-20 17:01:23');
...
CREATE TABLE `author_code`  (
  ...
  `validity_time` datetime NULL DEFAULT NULL COMMENT '有效时间',
  `is_use` tinyint(1) NULL DEFAULT 0 COMMENT '是否使用过，0：未使用，1:使用过',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `create_user_id` bigint(20) NULL DEFAULT NULL COMMENT '创建人ID',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `key_code`(`invite_code`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '作家邀请码表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of author_code
-- ----------------------------
INSERT INTO `author_code` VALUES (3, 'reerer', '2025-05-27 22:43:45', 1, '2020-05-13 11:40:56', 1);
INSERT INTO `author_code` VALUES (4, '123456', '2025-05-28 00:00:00', 1, '2020-05-13 14:09:55', 1);
INSERT INTO `author_code` VALUES (5, 'ww34343', '2025-05-21 00:00:00', 1, '2020-05-13 14:18:58', 1);
INSERT INTO `author_code` VALUES (6, '88888', '2025-07-20 00:00:00', 0, '2023-07-20 17:11:50', 1);
...
CREATE TABLE `author_income`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '稿费收入统计表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `author_income_detail`  (
  ...
  `create_time` datetime NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '稿费收入明细统计表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `book`  (
  ...
  `pic_url` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '小说封面',
  `book_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '小说名',
  ...
  `book_desc` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '书籍描述',
  `score` float NOT NULL COMMENT '评分，预留字段',
  `book_status` tinyint(1) NOT NULL DEFAULT 0 COMMENT '书籍状态，0：连载中，1：已完结',
  `visit_count` bigint(20) NULL DEFAULT 103 COMMENT '点击量',
  `word_count` int(11) NULL DEFAULT NULL COMMENT '总字数',
  `comment_count` int(11) NULL DEFAULT 0 COMMENT '评论数',
  `yesterday_buy` int(11) NULL DEFAULT 0 COMMENT '昨日订阅数',
  `last_index_id` bigint(20) NULL DEFAULT NULL COMMENT '最新目录ID',
  `last_index_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '最新目录名',
  `last_index_update_time` datetime NULL DEFAULT NULL COMMENT '最新目录更新时间',
  `is_vip` tinyint(1) NULL DEFAULT 0 COMMENT '是否收费，1：收费，0：免费',
  `status` tinyint(1) NULL DEFAULT 0 COMMENT '状态，0：入库，1：上架',
  `update_time` datetime NOT NULL COMMENT '更新时间',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `crawl_source_id` int(11) NULL DEFAULT NULL COMMENT '爬虫源站ID',
  `crawl_book_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '抓取的源站小说ID',
  `crawl_last_time` datetime NULL DEFAULT NULL COMMENT '最后一次的抓取时间',
  `crawl_is_stop` tinyint(1) NULL DEFAULT 0 COMMENT '是否已停止更新，0：未停止，1：已停止',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `key_uq_bookName_authorName`(`book_name`, `author_name`) USING BTREE,
  INDEX `key_lastIndexUpdateTime`(`last_index_update_time`) USING BTREE,
  INDEX `key_createTime`(`create_time`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1262260513468559364 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '小说表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of book
-- ----------------------------
INSERT INTO `book` VALUES (1262260513468559361, 0, 1, '玄幻奇幻', '/localPic/2023/07/20/86cb83778b574172927b37903220da67.jpg', '斗破苍穹', 2, '天蚕土豆', '这里是属于斗气的世界，没有花俏艳丽的魔法，有的，仅仅是繁衍到巅峰的斗气！ 心潮澎湃，无限幻想，迎风挥击千层浪，少年不败热血！ 新书等级制度：斗之气，斗者，斗师，大斗师，斗灵，斗王，斗皇，斗宗，斗尊，斗圣，斗帝。', 6.5, 0, 25, 422, 1, 0, 1681921125672071168, '第二章 斗气大陆', '2023-07-20 14:57:00', 0, 0, '2023-07-20 10:59:58', '2023-07-19 15:33:35', NULL, NULL, NULL, 0);
INSERT INTO `book` VALUES (1262260513468559362, 0, 1, '玄幻奇幻', '/localPic/2023/07/20/e2020ba459e84063bde6f196a6458557.jpg', '凡人修仙传', 3, '忘语', '一个普通山村小子，偶然下进入到当地江湖小门派，成了一名记名弟子。他以这样身份，如何在门派中立足,如何以平庸的资质进入到修仙者的行列，从而笑傲三界之中！&nbsp;　　续篇《凡人修仙之仙界篇》已经在起点中文网上传了，欢迎大家继续支持哦！&nbsp;　　凡人修仙，风云再起&nbsp;　　时空穿梭，轮回逆转&nbsp;　　金仙太乙，大罗道祖&nbsp;　　三千大道，法则至尊&nbsp;　　《凡人修仙传》仙界篇，一个韩立叱咤仙界的故事，一个凡人小子修仙的不灭传说。', 6.5, 0, 11, 265, 1, 0, 1681869263635783680, '第一章 山边小村', '2023-07-20 11:30:55', 0, 0, '2023-07-20 11:28:24', '2023-07-20 11:28:24', NULL, NULL, NULL, 0);
INSERT INTO `book` VALUES (1262260513468559363, 0, 1, '玄幻奇幻', '/localPic/2023/07/20/7f6a3f94b2c140f2a7400e0eba718631.png', '遮天', 4, '辰东', '冰冷与黑暗并存的宇宙深处，九具庞大的龙尸拉着一口青铜古棺，亘古长存。<br>这是太空探测器在枯寂的宇宙中捕捉到的一幅极其震撼的画面。<br>九龙拉棺，究竟是回到了上古，还是来到了星空的彼岸?<br>一个浩大的仙侠世界，光怪陆离，神秘无尽。热血似火山沸腾，激情若瀚海汹涌，欲望如深渊无止境……<br>登天路，踏歌行，弹指遮天。', 6.5, 0, 1, 1522, 0, 0, 1681953236751802368, '第一章 星空中的青铜巨棺', '2023-07-20 17:04:35', 0, 0, '2023-07-20 17:03:05', '2023-07-20 17:03:05', NULL, NULL, NULL, 0);
...
CREATE TABLE `book_author`  (
  ...
  `email` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '电子邮箱',
  `work_direction` tinyint(4) NULL DEFAULT NULL COMMENT '作品方向，0：男频，1：女频',
  `status` tinyint(4) NULL DEFAULT NULL COMMENT '0：待审核，1：审核通过，正常，2：审核不通过',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `create_user_id` bigint(20) NULL DEFAULT NULL COMMENT '申请人ID',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `update_user_id` bigint(20) NULL DEFAULT NULL COMMENT '更新人ID',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1254957873655066625 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '作者表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `book_category`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '小说类别表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `book_comment`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `book_id` bigint(20) NULL DEFAULT NULL COMMENT '小说ID',
  `comment_content` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '评价内容',
  ...
  `create_user_id` bigint(20) NULL DEFAULT NULL COMMENT '评价人',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `key_uq_bookid_userid`(`book_id`, `create_user_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '小说评论表' ROW_FORMAT = Dynamic;
...
INSERT INTO `book_comment` VALUES (13, 1262260513468559362, '很好看，看的入迷了', 0, 0, '2023-07-20 14:41:35', 1255060328322027520);
INSERT INTO `book_comment` VALUES (14, 1262260513468559361, '很不错，期待', 0, 0, '2023-07-20 17:07:16', 1681952053513478144);
...
CREATE TABLE `book_comment_reply`  (
  ...
  `audit_status` tinyint(1) NULL DEFAULT 0 COMMENT '审核状态，0：待审核，1：审核通过，2：审核不通过',
  `create_time` datetime NULL DEFAULT NULL COMMENT '回复用户ID',
  `create_user_id` bigint(20) NULL DEFAULT NULL COMMENT '回复时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '小说评论回复表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `book_content`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `index_id` bigint(20) NULL DEFAULT NULL COMMENT '目录ID',
...
) ENGINE = InnoDB AUTO_INCREMENT = 3347665 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '小说内容表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `book_content0`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `key_uq_indexId`(`index_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 888748933403115521 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '小说内容表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of book_content0
-- ----------------------------
INSERT INTO `book_content0` VALUES (888748933403115520, 1681869263635783680, '二愣子睁大着双眼，直直望着茅草和烂泥糊成的黑屋顶，身上盖着的旧棉被，已呈深黄色，看不出原来的本来面目，还若有若无的散发着淡淡的霉味。<br><br>在他身边紧挨着的另一人，是二哥韩铸，酣睡的十分香甜，从他身上不时传来轻重不一的阵阵打呼声。<br><br>离床大约半丈远的地方，是一堵黄泥糊成的土墙，因为时间过久，墙壁上裂开了几丝不起眼的细长口子，从这些裂纹中，隐隐约约的传来韩母唠唠叨叨的埋怨声，偶尔还掺杂着韩父，抽旱烟杆的“啪嗒”“啪嗒”吸允声。<br><br>二愣子缓缓的闭上已有些发涩的双目，迫使自己尽早进入深深的睡梦中。他心里非常清楚，再不老实入睡的话，明天就无法早起些了，也就无法和其他约好的同伴一起进山拣干柴。');
...
CREATE TABLE `book_content1`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `key_uq_indexId`(`index_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 406 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '小说内容表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `book_content2`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `key_uq_indexId`(`index_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1222 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '小说内容表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `book_content3`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `key_uq_indexId`(`index_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 410 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '小说内容表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `book_content4`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `key_uq_indexId`(`index_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1188 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '小说内容表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `book_content5`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `key_uq_indexId`(`index_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 416 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '小说内容表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `book_content6`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `key_uq_indexId`(`index_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1180 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '小说内容表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `book_content7`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `key_uq_indexId`(`index_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 404 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '小说内容表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `book_content8`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `key_uq_indexId`(`index_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 888832893349003265 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '小说内容表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of book_content8
-- ----------------------------
INSERT INTO `book_content8` VALUES (888449919633850368, 1681570233898815488, '陨落的天才');
INSERT INTO `book_content8` VALUES (888800782277672960, 1681921125672071168, '月如银盘，漫天繁星。<br>山崖之颠，萧炎斜躺在草地之上，嘴中叼中一根青草，微微嚼动，任由那淡淡的苦涩在嘴中弥漫开来…<br>举起有些白皙的手掌，挡在眼前，目光透过手指缝隙，遥望着天空上那轮巨大的银月。<br>“唉…”想起下午的测试，萧炎轻叹了一口气，懒懒的抽回手掌，双手枕着脑袋，眼神有些恍惚…<br>“十五年了呢…”低低的自喃声，忽然毫无边际的从少年嘴中轻吐了出来。<br>在萧炎的心中，有一个仅有他自己知道的秘密：他并不是这个世界的人，或者说，萧炎的灵魂，并不属于这个世界，他来自一个名叫地球的蔚蓝星球，至于为什么会来到这里，这种离奇经过，他也无法解释，不过在生活了一段时间之后，他还是后知后觉的明白了过来：他穿越了！<br>随着年龄的增长，对这块大陆，萧炎也是有了些模糊的了解…<br>大陆名为斗气大陆，大陆上并没有小说中常见的各系魔法，而斗气，才是大陆的唯一主调！<br>在这片大陆上，斗气的修炼，几乎已经在无数代人的努力之下，发展到了巅峰地步，而且由于斗气的不断繁衍，最后甚至扩散到了民间之中，这也导致，斗气，与人类的日常生活，变得息息相关，如此，斗气在大陆中的重要性，更是变得无可替代！');
INSERT INTO `book_content8` VALUES (888832893349003264, 1681953236751802368, '生命是世间最伟大的奇迹。<br><br>四方上下曰宇。宇虽有实，而无定处可求。往古来今曰宙。宙虽有增长，不知其始之所至。<br><br>浩瀚的宇宙，无垠的星空，许多科学家推测，地球可能是唯一的生命源地。<br><br>人类其实很孤独。在苍茫的天宇中，虽然有亿万星辰，但是却很难寻到第二颗生命源星。<br><br>不过人类从来没有放弃过探索，自上世纪以来已经发射诸多太空探测器。<br><br>旅行者二号是一艘无人外太空探测器，于一九七七年在美国肯尼迪航天中心发射升空。<br><br>它上面携带着一张主题为“向宇宙致意”的镀金唱片，里面包含一些流行音乐和用地球五十五种语言录制的问候辞，以冀有一天被可能存在的外星文明拦截和收到。<br><br>从上世纪七十年代到现在，旅行者二号一直在孤独的旅行，在茫茫宇宙中它如一粒尘埃般渺小。<br><br>同时代的外太空探测器，大多或已经发生故障，或已经中断讯号联系，永远的消失在了枯寂的宇宙中。<br><br>三十几年过去了，科技在不断发展，人类已经研制出更加先进的外太空探测器，也许不久的将来对星空的探索会取得更进一步的发展。<br><br>但纵然如此，在相当长的时间内，新型外太空探测器依然无法追上旅行者二号的步伐。<br><br>三十三年过去了，旅行者二号距离地球已经有一百四十亿公里。<br><br>此时此刻，它已经达到第三宇宙速度，轨道再也不能引导其飞返太阳系，成为了一艘星际太空船。<br><br>黑暗与冰冷的宇宙中，星辰点点，犹如一颗颗晶莹的钻石镶嵌在黑幕上。<br><br>旅行者二号太空探测器虽然正在极速飞行，但是在幽冷与无垠的宇宙中却像是一只小小的蚁虫在黑暗的大地上缓缓爬行。<br><br>三十多年过去后，就在今日这一刻，旅行者二号有了惊人的发现！<br><br>在枯寂的宇宙中，九具庞大的尸体静静的横在那里……<br><br>二零一零年五月二十二日，美国宇航局接收到旅行者二号传送回的一组神秘的数据信息，经过艰难的破译与还原，他们看到了一幅不可思议的画面。<br><br>在这一刻宇航局主监控室内所有人同时变色，最后如木雕泥塑般一动不动，他们震惊到了无以复加的地步！<br><br>直至过了很久众人才回过神来，而后主监控室内一下子沸腾了。<br><br>“上帝，我看到了什么？”<br><br>“这怎么可能，无法相信！”<br><br>……<br><br>旅行者二号早已不受引导，只能单一的前进，传送回这组神秘的数据信息后，在那片漆黑的宇宙空间匆匆而过，驶向更加幽暗与深远的星域。<br><br>由于那片星空太遥远，纵然有了重大发现，捕捉到了一幅震撼性的画面，人类目前也无能为力。<br><br>这组神秘信息并没有对外公布。而不久后，旅行者二号发生了故障，中断了与地球的讯号传送。<br><br>也许至此可以画上一个句号了，不过有时候事情往往会出乎人们的预料。<br><br>无论是对星空的观测与探索，还是进行生命与物理的科学研究，空间站都具有得天独厚的优越环境。<br><br>从一九七一年苏联首先发射载人空间站成功，到目前为止全世界已发射了九个空间站。<br><br>二零一零年六月十一日，此时此刻，绕地而行的国际空间站内，几名宇航员同时变了颜色，瞳孔急骤收缩。<br><br>时至今日，神的存在，早已被否定。如果还有人继续信仰，那也只是因心灵空虚而寻找一份寄托而已。<br><br>但是就在这一刻，几名宇航精英的思想受到了强烈的的冲击，他们看到了一幅不可思议的画面。<br><br>在国际空间站外，冰冷与黑暗并存的宇宙中，九条庞然大物一动不动，仿佛亘古就已横在那里，让人感觉到无尽的苍凉与久远，那竟然是九具龙尸！<br><br>与古代神话传说中的龙一般无二。<br><br>每具龙尸都长达百米，犹如铁水浇铸而成，充满了震撼性的力感。<br><br>九具龙尸皆是五爪黑龙，除却龙角晶莹剔透、紫光闪闪外，龙身通体呈黑色，乌光烁烁，鳞片在黑暗中闪烁着点点神秘的光华。<br><br>龙，传说中的存在，与神并立，凌驾于自然规律之上。但是，科学发展到现在，还有谁会相信龙真的存在？<br><br>国际空间站内的几名宇航员，思想受到了强烈的冲击，眼前所见让他们感觉不可思议！<br><br>枯寂的宇宙中，冰冷的龙尸似不可摧毁的钢铁长城，甚至能够感觉到尸身中所蕴含的恐怖力量。<br><br>只是，它们已经失去了生气，永远的安息在了幽冷的宇宙空间中。<br><br>“那是……”<br><br>被深深震撼过后，几名宇航精英的瞳孔再次急骤收缩，他们看到了更为让人震惊的画面。');
...
CREATE TABLE `book_content9`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `key_uq_indexId`(`index_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 415 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '小说内容表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `book_index`  (
  ...
  `is_vip` tinyint(4) NULL DEFAULT 0 COMMENT '是否收费，1：收费，0：免费',
  `book_price` int(3) NULL DEFAULT 0 COMMENT '章节费用（屋币）',
  `storage_type` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'db' COMMENT '存储方式',
  `create_time` datetime NULL DEFAULT NULL,
  `update_time` datetime NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `key_uq_bookId_indexNum`(`book_id`, `index_num`) USING BTREE,
  INDEX `key_bookId`(`book_id`) USING BTREE,
  INDEX `key_indexNum`(`index_num`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1681953236751802369 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '小说目录表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of book_index
-- ----------------------------
INSERT INTO `book_index` VALUES (1681570233898815488, 1262260513468559361, 0, '第一章 陨落的天才', 5, 0, 0, 'db', '2023-07-19 15:42:40', '2023-07-20 11:02:08');
INSERT INTO `book_index` VALUES (1681869263635783680, 1262260513468559362, 0, '第一章 山边小村', 265, 0, 1, 'db', '2023-07-20 11:30:55', '2023-07-20 11:30:55');
INSERT INTO `book_index` VALUES (1681921125672071168, 1262260513468559361, 1, '第二章 斗气大陆', 419, 1, 2, 'db', '2023-07-20 14:57:00', '2023-07-20 14:57:00');
INSERT INTO `book_index` VALUES (1681953236751802368, 1262260513468559363, 0, '第一章 星空中的青铜巨棺', 1522, 0, 7, 'db', '2023-07-20 17:04:35', '2023-07-20 17:04:35');
...
CREATE TABLE `book_screen_bullet`  (
  ...
  `screen_bullet` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '小说弹幕内容',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `key_contentId`(`content_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 79 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '小说弹幕表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `book_setting`  (
  ...
  `update_user_id` bigint(20) NULL DEFAULT NULL COMMENT '更新人ID',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 70 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '首页小说设置表' ROW_FORMAT = Dynamic;
...
INSERT INTO `book_setting` VALUES (64, 1262260513468559361, 1, 4, NULL, NULL, NULL, NULL);
INSERT INTO `book_setting` VALUES (65, 1262260513468559362, 1, 3, NULL, NULL, NULL, NULL);
INSERT INTO `book_setting` VALUES (66, 1262260513468559361, 1, 0, NULL, NULL, NULL, NULL);
INSERT INTO `book_setting` VALUES (67, 1262260513468559361, 1, 1, NULL, NULL, NULL, NULL);
INSERT INTO `book_setting` VALUES (68, 1262260513468559361, 1, 2, NULL, NULL, NULL, NULL);
INSERT INTO `book_setting` VALUES (69, 1262260513468559363, 1, 2, NULL, NULL, NULL, NULL);
...
CREATE TABLE `crawl_batch_task`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `source_id` int(11) NULL DEFAULT NULL COMMENT '爬虫源ID',
  `crawl_count_success` int(11) NULL DEFAULT NULL COMMENT '成功抓取数量',
  `crawl_count_target` int(11) NULL DEFAULT NULL COMMENT '目标抓取数量',
  `task_status` tinyint(1) NULL DEFAULT 1 COMMENT '任务状态，1：正在运行，0已停止',
  `start_time` datetime NULL DEFAULT NULL COMMENT '任务开始时间',
  `end_time` datetime NULL DEFAULT NULL COMMENT '任务结束时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '批量抓取任务表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `crawl_single_task`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `source_id` int(11) NULL DEFAULT NULL COMMENT '爬虫源ID',
  `source_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '爬虫源名',
  `source_book_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '源站小说ID',
  `cat_id` int(11) NULL DEFAULT NULL COMMENT '分类ID',
  `book_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '爬取的小说名',
  `author_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '爬取的小说作者名',
  `task_status` tinyint(1) NULL DEFAULT 2 COMMENT '任务状态，0：失败，1：成功，2；未执行',
  `exc_count` tinyint(2) NULL DEFAULT 0 COMMENT '已经执行次数，最多执行5次',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '抓取单本小说任务表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `crawl_source`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `source_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '源站名',
  `crawl_rule` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '爬取规则（json串）',
  `source_status` tinyint(1) NULL DEFAULT 0 COMMENT '爬虫源状态，0：关闭，1：开启',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '爬虫源表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `friend_link`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `link_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '链接名',
  `link_url` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '链接url',
  `sort` tinyint(4) NOT NULL DEFAULT 11 COMMENT '排序号',
  `is_open` tinyint(1) NOT NULL DEFAULT 1 COMMENT '是否开启，0：不开启，1：开启',
  `create_user_id` bigint(20) NULL DEFAULT NULL COMMENT '创建人id',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_user_id` bigint(20) NULL DEFAULT NULL COMMENT '更新者用户id',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `friend_link` VALUES (5, '爱看小说', 'https://ainovel.xxyopen.com', 11, 1, NULL, NULL, NULL, NULL);
...
CREATE TABLE `news`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `cat_id` int(11) NULL DEFAULT NULL COMMENT '类别ID',
  `cat_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '分类名',
  `source_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '来源',
  `title` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '标题',
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '内容',
  `read_count` bigint(20) NOT NULL DEFAULT 0 COMMENT '阅读量',
  `create_time` datetime NULL DEFAULT NULL COMMENT '发布时间',
  `create_user_id` bigint(20) NULL DEFAULT NULL COMMENT '发布人ID',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `update_user_id` bigint(20) NULL DEFAULT NULL COMMENT '更新人ID',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '新闻表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of news
-- ----------------------------
INSERT INTO `news` VALUES (1, 1, '行业', '未知', '阅文推“单本可选新合同”：授权分级、免费或付费自选', '阅文推“单本可选新合同”：授权分级、免费或付费自选', 1, '2020-04-27 15:42:21', NULL, '2020-04-27 15:42:26', NULL);
INSERT INTO `news` VALUES (2, 3, '资讯', '全媒派公众号', 'AI小说悄然流行：人类特有的创作力，已经被AI复制？', 'AI小说悄然流行：人类特有的创作力，已经被AI复制？', 1, '2020-04-28 15:44:07', NULL, '2020-04-28 15:44:12', NULL);
...
CREATE TABLE `news_category`  (
  ...
  `update_time` datetime NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '新闻类别表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `order_pay`  (
  ...
  `trade_no` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '支付宝/微信交易号',
  `member_type` int(11) DEFAULT '0' COMMENT '充值会员类型，1：月付，2：季付, 3：半年付, 4：年付',
  ...
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 24 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '充值订单' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of order_pay
-- ----------------------------
INSERT INTO `order_pay` VALUES (15, 202307191553322784, NULL, 1, 10, 1255060328322027520, 2, '2023-07-19 15:53:32', '2023-07-19 15:53:32');
INSERT INTO `order_pay` VALUES (16, 202307191553453315, NULL, 1, 10, 1255060328322027520, 2, '2023-07-19 15:53:45', '2023-07-19 15:53:45');
INSERT INTO `order_pay` VALUES (17, 202307191708225806, NULL, 1, 10, 1255060328322027520, 2, '2023-07-19 17:08:23', '2023-07-19 17:08:23');
INSERT INTO `order_pay` VALUES (18, 202307191710077615, NULL, 1, 10, 1255060328322027520, 1, '2023-07-19 17:10:08', '2023-07-19 17:10:42');
INSERT INTO `order_pay` VALUES (19, 202307191717412992, NULL, 1, 500, 1255060328322027520, 1, '2023-07-19 17:17:41', '2023-07-19 17:18:55');
INSERT INTO `order_pay` VALUES (20, 202307201446198798, NULL, 1, 10, 1255060328322027520, 2, '2023-07-20 14:46:20', '2023-07-20 14:46:20');
INSERT INTO `order_pay` VALUES (21, 202307201446394598, NULL, 1, 200, 1255060328322027520, 1, '2023-07-20 14:46:39', '2023-07-20 14:48:35');
INSERT INTO `order_pay` VALUES (22, 202307201705580299, NULL, 1, 500, 1681952053513478144, 2, '2023-07-20 17:05:58', '2023-07-20 17:05:58');
INSERT INTO `order_pay` VALUES (23, 202307201706067977, NULL, 1, 500, 1681952053513478144, 1, '2023-07-20 17:06:07', '2023-07-20 17:06:37');
...
CREATE TABLE `sys_data_perm`  (
  ...
  `table_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '数据表名称',
  `module_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '所属模块',
  `crl_attr_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '用户权限控制属性名',
  `crl_column_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '数据表权限控制列名',
  `perm_code` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '权限code，all_开头表示查看所有数据的权限，sup_开头表示查看下级数据的权限，own_开头表示查看本级数据的权限',
  `order_num` int(11) NULL DEFAULT NULL COMMENT '排序',
  `gmt_create` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `gmt_modified` datetime NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 216 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '数据权限管理' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 147 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '字典表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_dict` VALUES (142, '轮播图', '0', 'book_rec_type', '小说推荐类型', 0, NULL, NULL, NULL, NULL, NULL, '', NULL);
INSERT INTO `sys_dict` VALUES (143, '顶部小说栏', '1', 'book_rec_type', '小说推荐类型', 1, NULL, NULL, NULL, NULL, NULL, '', NULL);
INSERT INTO `sys_dict` VALUES (144, '本周强推', '2', 'book_rec_type', '小说推荐类型', 2, NULL, NULL, NULL, NULL, NULL, '', NULL);
INSERT INTO `sys_dict` VALUES (145, '热门推荐', '3', 'book_rec_type', '小说推荐类型', 3, NULL, NULL, NULL, NULL, NULL, '', NULL);
INSERT INTO `sys_dict` VALUES (146, '精品推荐', '4', 'book_rec_type', '小说推荐类型', 4, NULL, NULL, NULL, NULL, NULL, '', NULL);
...
CREATE TABLE `sys_file`  (
  ...
  `create_date` datetime NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 184 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '文件上传' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_file` VALUES (183, 0, '/files/2023/07/20/6a930e11-de09-4171-b1e7-0873ef57e569.jpg', '2023-07-20 15:04:33');
...
CREATE TABLE `sys_gen_columns`  (
  ...
  `java_type` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '映射java类型',
  `column_comment` varchar(1024) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '列注释',
  `column_sort` tinyint(4) NULL DEFAULT NULL COMMENT '列排序（升序）',
  `column_label` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '鍒楁爣绛惧悕',
  `page_type` tinyint(4) NULL DEFAULT 1 COMMENT '页面显示类型：1、文本框 2、下拉框 3、数值4、日期 5、文本域6、富文本 7、上传图片【单文件】 8、上传图片【多文件】9、上传文件【单文件】 10、上传文件【多文件】11、隐藏域 12、不显示',
...
CREATE TABLE `sys_log`  (
  ...
  `gmt_create` datetime NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1472 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统日志' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_log
-- ----------------------------
INSERT INTO `sys_log` VALUES (1412, -1, '获取用户信息为空', '登录', 179, 'com.java2nb.system.controller.LoginController.ajaxLogin()', NULL, '192.168.0.43', '2023-07-19 15:20:36');
INSERT INTO `sys_log` VALUES (1413, 1, 'admin', '登录', 52, 'com.java2nb.system.controller.LoginController.ajaxLogin()', NULL, '192.168.0.43', '2023-07-19 15:20:41');
INSERT INTO `sys_log` VALUES (1414, 1, 'admin', '请求访问主页', 34, 'com.java2nb.system.controller.LoginController.index()', '{\"menus\":[{\"attributes\":{\"icon\":\"fa fa-bars\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"/common/dict\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"78\",\"parentId\":\"1\",\"text\":\"数据字典\"},{\"attributes\":{\"icon\":\"fa fa-folder-open\",\"url\":\"/common/sysFile\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"71\",\"parentId\":\"1\",\"text\":\"文件管理\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"1\",\"parentId\":\"0\",\"text\":\"基础管理\"},{\"attributes\":{\"icon\":\"fa fa-desktop\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/user/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"6\",\"parentId\":\"3\",\"text\":\"用户管理\"},{\"attributes\":{\"icon\":\"fa fa-paw\",\"url\":\"sys/role\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"7\",\"parentId\":\"3\",\"text\":\"角色管理\"},{\"attributes\":{\"icon\":\"fa fa-th-list\",\"url\":\"sys/menu/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"2\",\"parentId\":\"3\",\"text\":\"系统菜单\"},{\"attributes\":{\"icon\":\"fa fa-users\",\"url\":\"/system/sysDept\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"73\",\"parentId\":\"3\",\"text\":\"部门管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"system/dataPerm\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"209\",\"parentId\":\"3\",\"text\":\"数据权限\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"3\",\"parentId\":\"0\",\"text\":\"系统管理\"},{\"attributes\":{\"icon\":\"fa fa-video-camera\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/online\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"92\",\"parentId\":\"91\",\"text\":\"在线用户\"},{\"attributes\":{\"icon\":\"fa fa-warning\",\"url\":\"common/log\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"27\",\"parentId\":\"91\",\"text\":\"系统日志\"},{\"attributes\":{\"icon\":\"fa fa-caret-square-o-right\",\"url\":\"/druid/index.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"57\",\"parentId\":\"91\",\"text\":\"运行监控\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"91\",\"parentId\":\"0\",\"text\":\"系统监控\"},{\"attributes\":{\"icon\":\"fa fa-gear\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"\",\"url\":\"/swagger-ui.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"104\",\"parentId\":\"77\",\"text\":\"swagger\"},{\"attributes\":{\"icon\":\"fa fa-code\",\"url\":\"common/generator\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"48\",\"parentId\":\"77\",\"text\":\"代码生成\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"77\",\"parentId\":\"0\",\"text\":\"研发工具\"},{\"attributes\":{\"icon\":\"fa fa-television\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/websiteInfo\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"301\",\"parentId\":\"300\",\"text\":\"网站信息\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookSetting\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"320\",\"parentId\":\"300\",\"text\":\"小说推荐\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/friendLink\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"310\",\"parentId\":\"300\",\"text\":\"友情链接\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"300\",\"parentId\":\"0\",\"text\":\"网站管理\"},{\"attributes\":{\"icon\":\"fa fa-newspaper-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/category\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"235\",\"parentId\":\"234\",\"text\":\"类别管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/news\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"241\",\"parentId\":\"234\",\"text\":\"新闻列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"234\",\"parentId\":\"0\",\"text\":\"新闻管理\"},{\"attributes\":{\"icon\":\"fa fa-vcard\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/user\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"401\",\"parentId\":\"400\",\"text\":\"会员列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/userFeedback\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"410\",\"parentId\":\"400\",\"text\":\"会员反馈\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"400\",\"parentId\":\"0\",\"text\":\"会员管理\"},{\"attributes\":{\"icon\":\"fa fa-user-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/authorCode\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"228\",\"parentId\":\"221\",\"text\":\"邀请码管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/author\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"222\",\"parentId\":\"221\",\"text\":\"作者列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"221\",\"parentId\":\"0\",\"text\":\"作家管理\"},{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/book\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"601\",\"parentId\":\"600\",\"text\":\"小说列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookComment\"},\"checked\":false,\"children\":[]', '192.168.0.43', '2023-07-19 15:20:41');
INSERT INTO `sys_log` VALUES (1415, 1, 'admin', '编辑角色', 4, 'com.java2nb.system.controller.RoleController.edit()', NULL, '192.168.0.43', '2023-07-19 15:21:30');
INSERT INTO `sys_log` VALUES (1416, 1, 'admin', '编辑用户', 17, 'com.java2nb.system.controller.SysUserController.edit()', NULL, '192.168.0.43', '2023-07-19 15:22:26');
INSERT INTO `sys_log` VALUES (1417, 1, 'admin', '添加用户', 4, 'com.java2nb.system.controller.SysUserController.add()', NULL, '192.168.0.43', '2023-07-19 15:22:34');
INSERT INTO `sys_log` VALUES (1418, 1, 'admin', '编辑角色', 4, 'com.java2nb.system.controller.RoleController.edit()', NULL, '192.168.0.43', '2023-07-19 15:22:41');
INSERT INTO `sys_log` VALUES (1419, 1, 'admin', '请求访问主页', 11, 'com.java2nb.system.controller.LoginController.index()', '{\"menus\":[{\"attributes\":{\"icon\":\"fa fa-bars\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"/common/dict\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"78\",\"parentId\":\"1\",\"text\":\"数据字典\"},{\"attributes\":{\"icon\":\"fa fa-folder-open\",\"url\":\"/common/sysFile\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"71\",\"parentId\":\"1\",\"text\":\"文件管理\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"1\",\"parentId\":\"0\",\"text\":\"基础管理\"},{\"attributes\":{\"icon\":\"fa fa-desktop\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/user/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"6\",\"parentId\":\"3\",\"text\":\"用户管理\"},{\"attributes\":{\"icon\":\"fa fa-paw\",\"url\":\"sys/role\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"7\",\"parentId\":\"3\",\"text\":\"角色管理\"},{\"attributes\":{\"icon\":\"fa fa-th-list\",\"url\":\"sys/menu/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"2\",\"parentId\":\"3\",\"text\":\"系统菜单\"},{\"attributes\":{\"icon\":\"fa fa-users\",\"url\":\"/system/sysDept\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"73\",\"parentId\":\"3\",\"text\":\"部门管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"system/dataPerm\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"209\",\"parentId\":\"3\",\"text\":\"数据权限\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"3\",\"parentId\":\"0\",\"text\":\"系统管理\"},{\"attributes\":{\"icon\":\"fa fa-video-camera\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/online\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"92\",\"parentId\":\"91\",\"text\":\"在线用户\"},{\"attributes\":{\"icon\":\"fa fa-warning\",\"url\":\"common/log\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"27\",\"parentId\":\"91\",\"text\":\"系统日志\"},{\"attributes\":{\"icon\":\"fa fa-caret-square-o-right\",\"url\":\"/druid/index.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"57\",\"parentId\":\"91\",\"text\":\"运行监控\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"91\",\"parentId\":\"0\",\"text\":\"系统监控\"},{\"attributes\":{\"icon\":\"fa fa-gear\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"\",\"url\":\"/swagger-ui.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"104\",\"parentId\":\"77\",\"text\":\"swagger\"},{\"attributes\":{\"icon\":\"fa fa-code\",\"url\":\"common/generator\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"48\",\"parentId\":\"77\",\"text\":\"代码生成\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"77\",\"parentId\":\"0\",\"text\":\"研发工具\"},{\"attributes\":{\"icon\":\"fa fa-television\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/websiteInfo\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"301\",\"parentId\":\"300\",\"text\":\"网站信息\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookSetting\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"320\",\"parentId\":\"300\",\"text\":\"小说推荐\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/friendLink\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"310\",\"parentId\":\"300\",\"text\":\"友情链接\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"300\",\"parentId\":\"0\",\"text\":\"网站管理\"},{\"attributes\":{\"icon\":\"fa fa-newspaper-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/category\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"235\",\"parentId\":\"234\",\"text\":\"类别管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/news\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"241\",\"parentId\":\"234\",\"text\":\"新闻列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"234\",\"parentId\":\"0\",\"text\":\"新闻管理\"},{\"attributes\":{\"icon\":\"fa fa-vcard\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/user\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"401\",\"parentId\":\"400\",\"text\":\"会员列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/userFeedback\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"410\",\"parentId\":\"400\",\"text\":\"会员反馈\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"400\",\"parentId\":\"0\",\"text\":\"会员管理\"},{\"attributes\":{\"icon\":\"fa fa-user-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/authorCode\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"228\",\"parentId\":\"221\",\"text\":\"邀请码管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/author\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"222\",\"parentId\":\"221\",\"text\":\"作者列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"221\",\"parentId\":\"0\",\"text\":\"作家管理\"},{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/book\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"601\",\"parentId\":\"600\",\"text\":\"小说列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookComment\"},\"checked\":false,\"children\":[]', '192.168.0.43', '2023-07-19 15:33:45');
INSERT INTO `sys_log` VALUES (1420, 1, 'admin', '请求访问主页', 9, 'com.java2nb.system.controller.LoginController.index()', '{\"menus\":[{\"attributes\":{\"icon\":\"fa fa-bars\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"/common/dict\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"78\",\"parentId\":\"1\",\"text\":\"数据字典\"},{\"attributes\":{\"icon\":\"fa fa-folder-open\",\"url\":\"/common/sysFile\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"71\",\"parentId\":\"1\",\"text\":\"文件管理\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"1\",\"parentId\":\"0\",\"text\":\"基础管理\"},{\"attributes\":{\"icon\":\"fa fa-desktop\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/user/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"6\",\"parentId\":\"3\",\"text\":\"用户管理\"},{\"attributes\":{\"icon\":\"fa fa-paw\",\"url\":\"sys/role\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"7\",\"parentId\":\"3\",\"text\":\"角色管理\"},{\"attributes\":{\"icon\":\"fa fa-th-list\",\"url\":\"sys/menu/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"2\",\"parentId\":\"3\",\"text\":\"系统菜单\"},{\"attributes\":{\"icon\":\"fa fa-users\",\"url\":\"/system/sysDept\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"73\",\"parentId\":\"3\",\"text\":\"部门管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"system/dataPerm\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"209\",\"parentId\":\"3\",\"text\":\"数据权限\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"3\",\"parentId\":\"0\",\"text\":\"系统管理\"},{\"attributes\":{\"icon\":\"fa fa-video-camera\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/online\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"92\",\"parentId\":\"91\",\"text\":\"在线用户\"},{\"attributes\":{\"icon\":\"fa fa-warning\",\"url\":\"common/log\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"27\",\"parentId\":\"91\",\"text\":\"系统日志\"},{\"attributes\":{\"icon\":\"fa fa-caret-square-o-right\",\"url\":\"/druid/index.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"57\",\"parentId\":\"91\",\"text\":\"运行监控\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"91\",\"parentId\":\"0\",\"text\":\"系统监控\"},{\"attributes\":{\"icon\":\"fa fa-gear\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"\",\"url\":\"/swagger-ui.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"104\",\"parentId\":\"77\",\"text\":\"swagger\"},{\"attributes\":{\"icon\":\"fa fa-code\",\"url\":\"common/generator\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"48\",\"parentId\":\"77\",\"text\":\"代码生成\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"77\",\"parentId\":\"0\",\"text\":\"研发工具\"},{\"attributes\":{\"icon\":\"fa fa-television\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookSetting\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"320\",\"parentId\":\"300\",\"text\":\"小说推荐\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/websiteInfo\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"301\",\"parentId\":\"300\",\"text\":\"网站信息\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/friendLink\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"310\",\"parentId\":\"300\",\"text\":\"友情链接\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"300\",\"parentId\":\"0\",\"text\":\"网站管理\"},{\"attributes\":{\"icon\":\"fa fa-newspaper-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/category\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"235\",\"parentId\":\"234\",\"text\":\"类别管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/news\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"241\",\"parentId\":\"234\",\"text\":\"新闻列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"234\",\"parentId\":\"0\",\"text\":\"新闻管理\"},{\"attributes\":{\"icon\":\"fa fa-vcard\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/user\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"401\",\"parentId\":\"400\",\"text\":\"会员列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/userFeedback\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"410\",\"parentId\":\"400\",\"text\":\"会员反馈\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"400\",\"parentId\":\"0\",\"text\":\"会员管理\"},{\"attributes\":{\"icon\":\"fa fa-user-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/authorCode\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"228\",\"parentId\":\"221\",\"text\":\"邀请码管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/author\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"222\",\"parentId\":\"221\",\"text\":\"作者列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"221\",\"parentId\":\"0\",\"text\":\"作家管理\"},{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/book\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"601\",\"parentId\":\"600\",\"text\":\"小说列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookComment\"},\"checked\":false,\"children\":[]', '192.168.0.43', '2023-07-19 15:43:47');
INSERT INTO `sys_log` VALUES (1421, 1, 'admin', '请求访问主页', 116, 'com.java2nb.system.controller.LoginController.index()', '{\"menus\":[{\"attributes\":{\"icon\":\"fa fa-bars\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"/common/dict\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"78\",\"parentId\":\"1\",\"text\":\"数据字典\"},{\"attributes\":{\"icon\":\"fa fa-folder-open\",\"url\":\"/common/sysFile\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"71\",\"parentId\":\"1\",\"text\":\"文件管理\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"1\",\"parentId\":\"0\",\"text\":\"基础管理\"},{\"attributes\":{\"icon\":\"fa fa-desktop\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/user/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"6\",\"parentId\":\"3\",\"text\":\"用户管理\"},{\"attributes\":{\"icon\":\"fa fa-paw\",\"url\":\"sys/role\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"7\",\"parentId\":\"3\",\"text\":\"角色管理\"},{\"attributes\":{\"icon\":\"fa fa-th-list\",\"url\":\"sys/menu/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"2\",\"parentId\":\"3\",\"text\":\"系统菜单\"},{\"attributes\":{\"icon\":\"fa fa-users\",\"url\":\"/system/sysDept\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"73\",\"parentId\":\"3\",\"text\":\"部门管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"system/dataPerm\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"209\",\"parentId\":\"3\",\"text\":\"数据权限\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"3\",\"parentId\":\"0\",\"text\":\"系统管理\"},{\"attributes\":{\"icon\":\"fa fa-video-camera\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/online\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"92\",\"parentId\":\"91\",\"text\":\"在线用户\"},{\"attributes\":{\"icon\":\"fa fa-warning\",\"url\":\"common/log\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"27\",\"parentId\":\"91\",\"text\":\"系统日志\"},{\"attributes\":{\"icon\":\"fa fa-caret-square-o-right\",\"url\":\"/druid/index.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"57\",\"parentId\":\"91\",\"text\":\"运行监控\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"91\",\"parentId\":\"0\",\"text\":\"系统监控\"},{\"attributes\":{\"icon\":\"fa fa-gear\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"\",\"url\":\"/swagger-ui.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"104\",\"parentId\":\"77\",\"text\":\"swagger\"},{\"attributes\":{\"icon\":\"fa fa-code\",\"url\":\"common/generator\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"48\",\"parentId\":\"77\",\"text\":\"代码生成\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"77\",\"parentId\":\"0\",\"text\":\"研发工具\"},{\"attributes\":{\"icon\":\"fa fa-television\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/websiteInfo\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"301\",\"parentId\":\"300\",\"text\":\"网站信息\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookSetting\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"320\",\"parentId\":\"300\",\"text\":\"小说推荐\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/friendLink\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"310\",\"parentId\":\"300\",\"text\":\"友情链接\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"300\",\"parentId\":\"0\",\"text\":\"网站管理\"},{\"attributes\":{\"icon\":\"fa fa-newspaper-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/category\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"235\",\"parentId\":\"234\",\"text\":\"类别管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/news\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"241\",\"parentId\":\"234\",\"text\":\"新闻列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"234\",\"parentId\":\"0\",\"text\":\"新闻管理\"},{\"attributes\":{\"icon\":\"fa fa-vcard\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/user\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"401\",\"parentId\":\"400\",\"text\":\"会员列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/userFeedback\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"410\",\"parentId\":\"400\",\"text\":\"会员反馈\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"400\",\"parentId\":\"0\",\"text\":\"会员管理\"},{\"attributes\":{\"icon\":\"fa fa-user-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/authorCode\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"228\",\"parentId\":\"221\",\"text\":\"邀请码管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/author\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"222\",\"parentId\":\"221\",\"text\":\"作者列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"221\",\"parentId\":\"0\",\"text\":\"作家管理\"},{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/book\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"601\",\"parentId\":\"600\",\"text\":\"小说列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookComment\"},\"checked\":false,\"children\":[]', '192.168.0.43', '2023-07-19 15:52:19');
INSERT INTO `sys_log` VALUES (1422, 1, 'admin', '请求访问主页', 117, 'com.java2nb.system.controller.LoginController.index()', '{\"menus\":[{\"attributes\":{\"icon\":\"fa fa-bars\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"/common/dict\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"78\",\"parentId\":\"1\",\"text\":\"数据字典\"},{\"attributes\":{\"icon\":\"fa fa-folder-open\",\"url\":\"/common/sysFile\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"71\",\"parentId\":\"1\",\"text\":\"文件管理\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"1\",\"parentId\":\"0\",\"text\":\"基础管理\"},{\"attributes\":{\"icon\":\"fa fa-desktop\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/user/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"6\",\"parentId\":\"3\",\"text\":\"用户管理\"},{\"attributes\":{\"icon\":\"fa fa-paw\",\"url\":\"sys/role\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"7\",\"parentId\":\"3\",\"text\":\"角色管理\"},{\"attributes\":{\"icon\":\"fa fa-th-list\",\"url\":\"sys/menu/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"2\",\"parentId\":\"3\",\"text\":\"系统菜单\"},{\"attributes\":{\"icon\":\"fa fa-users\",\"url\":\"/system/sysDept\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"73\",\"parentId\":\"3\",\"text\":\"部门管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"system/dataPerm\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"209\",\"parentId\":\"3\",\"text\":\"数据权限\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"3\",\"parentId\":\"0\",\"text\":\"系统管理\"},{\"attributes\":{\"icon\":\"fa fa-video-camera\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/online\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"92\",\"parentId\":\"91\",\"text\":\"在线用户\"},{\"attributes\":{\"icon\":\"fa fa-warning\",\"url\":\"common/log\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"27\",\"parentId\":\"91\",\"text\":\"系统日志\"},{\"attributes\":{\"icon\":\"fa fa-caret-square-o-right\",\"url\":\"/druid/index.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"57\",\"parentId\":\"91\",\"text\":\"运行监控\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"91\",\"parentId\":\"0\",\"text\":\"系统监控\"},{\"attributes\":{\"icon\":\"fa fa-gear\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"\",\"url\":\"/swagger-ui.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"104\",\"parentId\":\"77\",\"text\":\"swagger\"},{\"attributes\":{\"icon\":\"fa fa-code\",\"url\":\"common/generator\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"48\",\"parentId\":\"77\",\"text\":\"代码生成\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"77\",\"parentId\":\"0\",\"text\":\"研发工具\"},{\"attributes\":{\"icon\":\"fa fa-television\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookSetting\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"320\",\"parentId\":\"300\",\"text\":\"小说推荐\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/websiteInfo\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"301\",\"parentId\":\"300\",\"text\":\"网站信息\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/friendLink\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"310\",\"parentId\":\"300\",\"text\":\"友情链接\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"300\",\"parentId\":\"0\",\"text\":\"网站管理\"},{\"attributes\":{\"icon\":\"fa fa-newspaper-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/category\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"235\",\"parentId\":\"234\",\"text\":\"类别管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/news\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"241\",\"parentId\":\"234\",\"text\":\"新闻列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"234\",\"parentId\":\"0\",\"text\":\"新闻管理\"},{\"attributes\":{\"icon\":\"fa fa-vcard\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/user\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"401\",\"parentId\":\"400\",\"text\":\"会员列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/userFeedback\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"410\",\"parentId\":\"400\",\"text\":\"会员反馈\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"400\",\"parentId\":\"0\",\"text\":\"会员管理\"},{\"attributes\":{\"icon\":\"fa fa-user-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/authorCode\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"228\",\"parentId\":\"221\",\"text\":\"邀请码管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/author\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"222\",\"parentId\":\"221\",\"text\":\"作者列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"221\",\"parentId\":\"0\",\"text\":\"作家管理\"},{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/book\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"601\",\"parentId\":\"600\",\"text\":\"小说列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookComment\"},\"checked\":false,\"children\":[]', '192.168.0.43', '2023-07-19 16:04:41');
INSERT INTO `sys_log` VALUES (1423, 1, 'admin', '请求访问主页', 9, 'com.java2nb.system.controller.LoginController.index()', '{\"menus\":[{\"attributes\":{\"icon\":\"fa fa-bars\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"/common/dict\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"78\",\"parentId\":\"1\",\"text\":\"数据字典\"},{\"attributes\":{\"icon\":\"fa fa-folder-open\",\"url\":\"/common/sysFile\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"71\",\"parentId\":\"1\",\"text\":\"文件管理\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"1\",\"parentId\":\"0\",\"text\":\"基础管理\"},{\"attributes\":{\"icon\":\"fa fa-desktop\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/user/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"6\",\"parentId\":\"3\",\"text\":\"用户管理\"},{\"attributes\":{\"icon\":\"fa fa-paw\",\"url\":\"sys/role\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"7\",\"parentId\":\"3\",\"text\":\"角色管理\"},{\"attributes\":{\"icon\":\"fa fa-th-list\",\"url\":\"sys/menu/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"2\",\"parentId\":\"3\",\"text\":\"系统菜单\"},{\"attributes\":{\"icon\":\"fa fa-users\",\"url\":\"/system/sysDept\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"73\",\"parentId\":\"3\",\"text\":\"部门管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"system/dataPerm\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"209\",\"parentId\":\"3\",\"text\":\"数据权限\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"3\",\"parentId\":\"0\",\"text\":\"系统管理\"},{\"attributes\":{\"icon\":\"fa fa-video-camera\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/online\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"92\",\"parentId\":\"91\",\"text\":\"在线用户\"},{\"attributes\":{\"icon\":\"fa fa-warning\",\"url\":\"common/log\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"27\",\"parentId\":\"91\",\"text\":\"系统日志\"},{\"attributes\":{\"icon\":\"fa fa-caret-square-o-right\",\"url\":\"/druid/index.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"57\",\"parentId\":\"91\",\"text\":\"运行监控\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"91\",\"parentId\":\"0\",\"text\":\"系统监控\"},{\"attributes\":{\"icon\":\"fa fa-gear\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"\",\"url\":\"/swagger-ui.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"104\",\"parentId\":\"77\",\"text\":\"swagger\"},{\"attributes\":{\"icon\":\"fa fa-code\",\"url\":\"common/generator\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"48\",\"parentId\":\"77\",\"text\":\"代码生成\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"77\",\"parentId\":\"0\",\"text\":\"研发工具\"},{\"attributes\":{\"icon\":\"fa fa-television\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/websiteInfo\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"301\",\"parentId\":\"300\",\"text\":\"网站信息\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookSetting\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"320\",\"parentId\":\"300\",\"text\":\"小说推荐\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/friendLink\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"310\",\"parentId\":\"300\",\"text\":\"友情链接\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"300\",\"parentId\":\"0\",\"text\":\"网站管理\"},{\"attributes\":{\"icon\":\"fa fa-newspaper-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/category\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"235\",\"parentId\":\"234\",\"text\":\"类别管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/news\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"241\",\"parentId\":\"234\",\"text\":\"新闻列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"234\",\"parentId\":\"0\",\"text\":\"新闻管理\"},{\"attributes\":{\"icon\":\"fa fa-vcard\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/user\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"401\",\"parentId\":\"400\",\"text\":\"会员列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/userFeedback\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"410\",\"parentId\":\"400\",\"text\":\"会员反馈\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"400\",\"parentId\":\"0\",\"text\":\"会员管理\"},{\"attributes\":{\"icon\":\"fa fa-user-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/authorCode\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"228\",\"parentId\":\"221\",\"text\":\"邀请码管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/author\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"222\",\"parentId\":\"221\",\"text\":\"作者列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"221\",\"parentId\":\"0\",\"text\":\"作家管理\"},{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/book\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"601\",\"parentId\":\"600\",\"text\":\"小说列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookComment\"},\"checked\":false,\"children\":[]', '192.168.0.43', '2023-07-19 16:06:38');
INSERT INTO `sys_log` VALUES (1424, 1, 'admin', '添加菜单', 7, 'com.java2nb.system.controller.MenuController.add()', NULL, '192.168.0.43', '2023-07-19 16:10:50');
INSERT INTO `sys_log` VALUES (1425, 1, 'admin', '添加菜单', 5, 'com.java2nb.system.controller.MenuController.add()', NULL, '192.168.0.43', '2023-07-19 16:11:03');
INSERT INTO `sys_log` VALUES (1426, 1, 'admin', '编辑菜单', 9, 'com.java2nb.system.controller.MenuController.edit()', NULL, '192.168.0.43', '2023-07-19 16:11:36');
INSERT INTO `sys_log` VALUES (1427, 1, 'admin', '添加菜单', 5, 'com.java2nb.system.controller.MenuController.add()', NULL, '192.168.0.43', '2023-07-19 16:12:33');
INSERT INTO `sys_log` VALUES (1428, 1, 'admin', '保存菜单', 7, 'com.java2nb.system.controller.MenuController.save()', NULL, '192.168.0.43', '2023-07-19 16:12:41');
INSERT INTO `sys_log` VALUES (1429, 1, 'admin', '添加菜单', 5, 'com.java2nb.system.controller.MenuController.add()', NULL, '192.168.0.43', '2023-07-19 16:13:06');
INSERT INTO `sys_log` VALUES (1430, 1, 'admin', '保存菜单', 7, 'com.java2nb.system.controller.MenuController.save()', NULL, '192.168.0.43', '2023-07-19 16:13:23');
INSERT INTO `sys_log` VALUES (1431, 1, 'admin', '编辑菜单', 11, 'com.java2nb.system.controller.MenuController.edit()', NULL, '192.168.0.43', '2023-07-19 16:13:31');
INSERT INTO `sys_log` VALUES (1432, 1, 'admin', '编辑菜单', 10, 'com.java2nb.system.controller.MenuController.edit()', NULL, '192.168.0.43', '2023-07-19 16:13:40');
INSERT INTO `sys_log` VALUES (1433, 1, 'admin', '编辑菜单', 9, 'com.java2nb.system.controller.MenuController.edit()', NULL, '192.168.0.43', '2023-07-19 16:15:07');
INSERT INTO `sys_log` VALUES (1434, 1, 'admin', '编辑菜单', 9, 'com.java2nb.system.controller.MenuController.edit()', NULL, '192.168.0.43', '2023-07-19 16:15:18');
INSERT INTO `sys_log` VALUES (1435, 1, 'admin', '更新菜单', 10, 'com.java2nb.system.controller.MenuController.update()', NULL, '192.168.0.43', '2023-07-19 16:15:23');
INSERT INTO `sys_log` VALUES (1436, 1, 'admin', '添加菜单', 5, 'com.java2nb.system.controller.MenuController.add()', NULL, '192.168.0.43', '2023-07-19 16:15:34');
INSERT INTO `sys_log` VALUES (1437, 1, 'admin', '保存菜单', 6, 'com.java2nb.system.controller.MenuController.save()', NULL, '192.168.0.43', '2023-07-19 16:15:51');
INSERT INTO `sys_log` VALUES (1438, 1, 'admin', '编辑角色', 5, 'com.java2nb.system.controller.RoleController.edit()', NULL, '192.168.0.43', '2023-07-19 16:16:19');
INSERT INTO `sys_log` VALUES (1439, 1, 'admin', '更新角色', 42, 'com.java2nb.system.controller.RoleController.update()', NULL, '192.168.0.43', '2023-07-19 16:16:24');
INSERT INTO `sys_log` VALUES (1440, 1, 'admin', '请求访问主页', 105, 'com.java2nb.system.controller.LoginController.index()', '{\"menus\":[{\"attributes\":{\"icon\":\"fa fa-bars\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"/common/dict\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"78\",\"parentId\":\"1\",\"text\":\"数据字典\"},{\"attributes\":{\"icon\":\"fa fa-folder-open\",\"url\":\"/common/sysFile\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"71\",\"parentId\":\"1\",\"text\":\"文件管理\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"1\",\"parentId\":\"0\",\"text\":\"基础管理\"},{\"attributes\":{\"icon\":\"fa fa-desktop\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/user/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"6\",\"parentId\":\"3\",\"text\":\"用户管理\"},{\"attributes\":{\"icon\":\"fa fa-paw\",\"url\":\"sys/role\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"7\",\"parentId\":\"3\",\"text\":\"角色管理\"},{\"attributes\":{\"icon\":\"fa fa-th-list\",\"url\":\"sys/menu/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"2\",\"parentId\":\"3\",\"text\":\"系统菜单\"},{\"attributes\":{\"icon\":\"fa fa-users\",\"url\":\"/system/sysDept\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"73\",\"parentId\":\"3\",\"text\":\"部门管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"system/dataPerm\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"209\",\"parentId\":\"3\",\"text\":\"数据权限\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"3\",\"parentId\":\"0\",\"text\":\"系统管理\"},{\"attributes\":{\"icon\":\"fa fa-video-camera\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/online\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"92\",\"parentId\":\"91\",\"text\":\"在线用户\"},{\"attributes\":{\"icon\":\"fa fa-warning\",\"url\":\"common/log\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"27\",\"parentId\":\"91\",\"text\":\"系统日志\"},{\"attributes\":{\"icon\":\"fa fa-caret-square-o-right\",\"url\":\"/druid/index.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"57\",\"parentId\":\"91\",\"text\":\"运行监控\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"91\",\"parentId\":\"0\",\"text\":\"系统监控\"},{\"attributes\":{\"icon\":\"fa fa-gear\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"\",\"url\":\"/swagger-ui.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"104\",\"parentId\":\"77\",\"text\":\"swagger\"},{\"attributes\":{\"icon\":\"fa fa-code\",\"url\":\"common/generator\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"48\",\"parentId\":\"77\",\"text\":\"代码生成\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"77\",\"parentId\":\"0\",\"text\":\"研发工具\"},{\"attributes\":{\"icon\":\"fa fa-television\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookSetting\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"320\",\"parentId\":\"300\",\"text\":\"小说推荐\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/websiteInfo\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"301\",\"parentId\":\"300\",\"text\":\"网站信息\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/friendLink\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"310\",\"parentId\":\"300\",\"text\":\"友情链接\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"300\",\"parentId\":\"0\",\"text\":\"网站管理\"},{\"attributes\":{\"icon\":\"fa fa-newspaper-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/category\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"235\",\"parentId\":\"234\",\"text\":\"类别管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/news\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"241\",\"parentId\":\"234\",\"text\":\"新闻列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"234\",\"parentId\":\"0\",\"text\":\"新闻管理\"},{\"attributes\":{\"icon\":\"fa fa-vcard\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/user\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"401\",\"parentId\":\"400\",\"text\":\"会员列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/userFeedback\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"410\",\"parentId\":\"400\",\"text\":\"会员反馈\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"400\",\"parentId\":\"0\",\"text\":\"会员管理\"},{\"attributes\":{\"icon\":\"fa fa-user-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/authorCode\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"228\",\"parentId\":\"221\",\"text\":\"邀请码管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/author\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"222\",\"parentId\":\"221\",\"text\":\"作者列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"221\",\"parentId\":\"0\",\"text\":\"作家管理\"},{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/book\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"601\",\"parentId\":\"600\",\"text\":\"小说列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookComment\"},\"checked\":false,\"children\":[]', '192.168.0.43', '2023-07-19 16:18:19');
INSERT INTO `sys_log` VALUES (1441, 1, 'admin', '请求访问主页', 10, 'com.java2nb.system.controller.LoginController.index()', '{\"menus\":[{\"attributes\":{\"icon\":\"fa fa-bars\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"/common/dict\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"78\",\"parentId\":\"1\",\"text\":\"数据字典\"},{\"attributes\":{\"icon\":\"fa fa-folder-open\",\"url\":\"/common/sysFile\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"71\",\"parentId\":\"1\",\"text\":\"文件管理\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"1\",\"parentId\":\"0\",\"text\":\"基础管理\"},{\"attributes\":{\"icon\":\"fa fa-desktop\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/user/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"6\",\"parentId\":\"3\",\"text\":\"用户管理\"},{\"attributes\":{\"icon\":\"fa fa-paw\",\"url\":\"sys/role\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"7\",\"parentId\":\"3\",\"text\":\"角色管理\"},{\"attributes\":{\"icon\":\"fa fa-th-list\",\"url\":\"sys/menu/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"2\",\"parentId\":\"3\",\"text\":\"系统菜单\"},{\"attributes\":{\"icon\":\"fa fa-users\",\"url\":\"/system/sysDept\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"73\",\"parentId\":\"3\",\"text\":\"部门管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"system/dataPerm\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"209\",\"parentId\":\"3\",\"text\":\"数据权限\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"3\",\"parentId\":\"0\",\"text\":\"系统管理\"},{\"attributes\":{\"icon\":\"fa fa-video-camera\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/online\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"92\",\"parentId\":\"91\",\"text\":\"在线用户\"},{\"attributes\":{\"icon\":\"fa fa-warning\",\"url\":\"common/log\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"27\",\"parentId\":\"91\",\"text\":\"系统日志\"},{\"attributes\":{\"icon\":\"fa fa-caret-square-o-right\",\"url\":\"/druid/index.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"57\",\"parentId\":\"91\",\"text\":\"运行监控\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"91\",\"parentId\":\"0\",\"text\":\"系统监控\"},{\"attributes\":{\"icon\":\"fa fa-gear\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"\",\"url\":\"/swagger-ui.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"104\",\"parentId\":\"77\",\"text\":\"swagger\"},{\"attributes\":{\"icon\":\"fa fa-code\",\"url\":\"common/generator\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"48\",\"parentId\":\"77\",\"text\":\"代码生成\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"77\",\"parentId\":\"0\",\"text\":\"研发工具\"},{\"attributes\":{\"icon\":\"fa fa-television\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookSetting\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"320\",\"parentId\":\"300\",\"text\":\"小说推荐\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/websiteInfo\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"301\",\"parentId\":\"300\",\"text\":\"网站信息\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/friendLink\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"310\",\"parentId\":\"300\",\"text\":\"友情链接\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"300\",\"parentId\":\"0\",\"text\":\"网站管理\"},{\"attributes\":{\"icon\":\"fa fa-newspaper-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/category\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"235\",\"parentId\":\"234\",\"text\":\"类别管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/news\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"241\",\"parentId\":\"234\",\"text\":\"新闻列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"234\",\"parentId\":\"0\",\"text\":\"新闻管理\"},{\"attributes\":{\"icon\":\"fa fa-vcard\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/user\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"401\",\"parentId\":\"400\",\"text\":\"会员列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/userFeedback\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"410\",\"parentId\":\"400\",\"text\":\"会员反馈\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"400\",\"parentId\":\"0\",\"text\":\"会员管理\"},{\"attributes\":{\"icon\":\"fa fa-user-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/authorCode\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"228\",\"parentId\":\"221\",\"text\":\"邀请码管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/author\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"222\",\"parentId\":\"221\",\"text\":\"作者列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"221\",\"parentId\":\"0\",\"text\":\"作家管理\"},{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/book\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"601\",\"parentId\":\"600\",\"text\":\"小说列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookComment\"},\"checked\":false,\"children\":[]', '192.168.0.43', '2023-07-19 16:18:28');
INSERT INTO `sys_log` VALUES (1442, 1, 'admin', '编辑角色', 5, 'com.java2nb.system.controller.RoleController.edit()', NULL, '192.168.0.43', '2023-07-19 16:21:20');
INSERT INTO `sys_log` VALUES (1443, 1, 'admin', '请求访问主页', 11, 'com.java2nb.system.controller.LoginController.index()', '{\"menus\":[{\"attributes\":{\"icon\":\"fa fa-bars\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"/common/dict\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"78\",\"parentId\":\"1\",\"text\":\"数据字典\"},{\"attributes\":{\"icon\":\"fa fa-folder-open\",\"url\":\"/common/sysFile\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"71\",\"parentId\":\"1\",\"text\":\"文件管理\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"1\",\"parentId\":\"0\",\"text\":\"基础管理\"},{\"attributes\":{\"icon\":\"fa fa-desktop\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/user/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"6\",\"parentId\":\"3\",\"text\":\"用户管理\"},{\"attributes\":{\"icon\":\"fa fa-paw\",\"url\":\"sys/role\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"7\",\"parentId\":\"3\",\"text\":\"角色管理\"},{\"attributes\":{\"icon\":\"fa fa-th-list\",\"url\":\"sys/menu/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"2\",\"parentId\":\"3\",\"text\":\"系统菜单\"},{\"attributes\":{\"icon\":\"fa fa-users\",\"url\":\"/system/sysDept\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"73\",\"parentId\":\"3\",\"text\":\"部门管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"system/dataPerm\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"209\",\"parentId\":\"3\",\"text\":\"数据权限\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"3\",\"parentId\":\"0\",\"text\":\"系统管理\"},{\"attributes\":{\"icon\":\"fa fa-video-camera\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/online\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"92\",\"parentId\":\"91\",\"text\":\"在线用户\"},{\"attributes\":{\"icon\":\"fa fa-warning\",\"url\":\"common/log\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"27\",\"parentId\":\"91\",\"text\":\"系统日志\"},{\"attributes\":{\"icon\":\"fa fa-caret-square-o-right\",\"url\":\"/druid/index.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"57\",\"parentId\":\"91\",\"text\":\"运行监控\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"91\",\"parentId\":\"0\",\"text\":\"系统监控\"},{\"attributes\":{\"icon\":\"fa fa-gear\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"\",\"url\":\"/swagger-ui.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"104\",\"parentId\":\"77\",\"text\":\"swagger\"},{\"attributes\":{\"icon\":\"fa fa-code\",\"url\":\"common/generator\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"48\",\"parentId\":\"77\",\"text\":\"代码生成\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"77\",\"parentId\":\"0\",\"text\":\"研发工具\"},{\"attributes\":{\"icon\":\"fa fa-television\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/websiteInfo\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"301\",\"parentId\":\"300\",\"text\":\"网站信息\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookSetting\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"320\",\"parentId\":\"300\",\"text\":\"小说推荐\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/friendLink\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"310\",\"parentId\":\"300\",\"text\":\"友情链接\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"300\",\"parentId\":\"0\",\"text\":\"网站管理\"},{\"attributes\":{\"icon\":\"fa fa-newspaper-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/category\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"235\",\"parentId\":\"234\",\"text\":\"类别管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/news\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"241\",\"parentId\":\"234\",\"text\":\"新闻列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"234\",\"parentId\":\"0\",\"text\":\"新闻管理\"},{\"attributes\":{\"icon\":\"fa fa-vcard\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/user\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"401\",\"parentId\":\"400\",\"text\":\"会员列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/userFeedback\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"410\",\"parentId\":\"400\",\"text\":\"会员反馈\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"400\",\"parentId\":\"0\",\"text\":\"会员管理\"},{\"attributes\":{\"icon\":\"fa fa-user-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/authorCode\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"228\",\"parentId\":\"221\",\"text\":\"邀请码管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/author\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"222\",\"parentId\":\"221\",\"text\":\"作者列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"221\",\"parentId\":\"0\",\"text\":\"作家管理\"},{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/book\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"601\",\"parentId\":\"600\",\"text\":\"小说列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookComment\"},\"checked\":false,\"children\":[]', '192.168.0.43', '2023-07-19 16:22:14');
INSERT INTO `sys_log` VALUES (1444, -1, '获取用户信息为空', '登录', 167, 'com.java2nb.system.controller.LoginController.ajaxLogin()', NULL, '127.0.0.1', '2023-07-20 10:34:05');
INSERT INTO `sys_log` VALUES (1445, 1, 'admin', '登录', 31, 'com.java2nb.system.controller.LoginController.ajaxLogin()', NULL, '127.0.0.1', '2023-07-20 10:34:09');
INSERT INTO `sys_log` VALUES (1446, 1, 'admin', '请求访问主页', 28, 'com.java2nb.system.controller.LoginController.index()', '{\"menus\":[{\"attributes\":{\"icon\":\"fa fa-bars\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"/common/dict\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"78\",\"parentId\":\"1\",\"text\":\"数据字典\"},{\"attributes\":{\"icon\":\"fa fa-folder-open\",\"url\":\"/common/sysFile\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"71\",\"parentId\":\"1\",\"text\":\"文件管理\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"1\",\"parentId\":\"0\",\"text\":\"基础管理\"},{\"attributes\":{\"icon\":\"fa fa-desktop\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/user/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"6\",\"parentId\":\"3\",\"text\":\"用户管理\"},{\"attributes\":{\"icon\":\"fa fa-paw\",\"url\":\"sys/role\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"7\",\"parentId\":\"3\",\"text\":\"角色管理\"},{\"attributes\":{\"icon\":\"fa fa-th-list\",\"url\":\"sys/menu/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"2\",\"parentId\":\"3\",\"text\":\"系统菜单\"},{\"attributes\":{\"icon\":\"fa fa-users\",\"url\":\"/system/sysDept\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"73\",\"parentId\":\"3\",\"text\":\"部门管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"system/dataPerm\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"209\",\"parentId\":\"3\",\"text\":\"数据权限\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"3\",\"parentId\":\"0\",\"text\":\"系统管理\"},{\"attributes\":{\"icon\":\"fa fa-video-camera\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/online\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"92\",\"parentId\":\"91\",\"text\":\"在线用户\"},{\"attributes\":{\"icon\":\"fa fa-warning\",\"url\":\"common/log\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"27\",\"parentId\":\"91\",\"text\":\"系统日志\"},{\"attributes\":{\"icon\":\"fa fa-caret-square-o-right\",\"url\":\"/druid/index.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"57\",\"parentId\":\"91\",\"text\":\"运行监控\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"91\",\"parentId\":\"0\",\"text\":\"系统监控\"},{\"attributes\":{\"icon\":\"fa fa-gear\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"\",\"url\":\"/swagger-ui.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"104\",\"parentId\":\"77\",\"text\":\"swagger\"},{\"attributes\":{\"icon\":\"fa fa-code\",\"url\":\"common/generator\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"48\",\"parentId\":\"77\",\"text\":\"代码生成\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"77\",\"parentId\":\"0\",\"text\":\"研发工具\"},{\"attributes\":{\"icon\":\"fa fa-television\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookSetting\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"320\",\"parentId\":\"300\",\"text\":\"小说推荐\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/websiteInfo\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"301\",\"parentId\":\"300\",\"text\":\"网站信息\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/friendLink\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"310\",\"parentId\":\"300\",\"text\":\"友情链接\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"300\",\"parentId\":\"0\",\"text\":\"网站管理\"},{\"attributes\":{\"icon\":\"fa fa-newspaper-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/category\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"235\",\"parentId\":\"234\",\"text\":\"类别管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/news\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"241\",\"parentId\":\"234\",\"text\":\"新闻列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"234\",\"parentId\":\"0\",\"text\":\"新闻管理\"},{\"attributes\":{\"icon\":\"fa fa-vcard\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/user\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"401\",\"parentId\":\"400\",\"text\":\"会员列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/userFeedback\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"410\",\"parentId\":\"400\",\"text\":\"会员反馈\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"400\",\"parentId\":\"0\",\"text\":\"会员管理\"},{\"attributes\":{\"icon\":\"fa fa-user-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/authorCode\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"228\",\"parentId\":\"221\",\"text\":\"邀请码管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/author\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"222\",\"parentId\":\"221\",\"text\":\"作者列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"221\",\"parentId\":\"0\",\"text\":\"作家管理\"},{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/book\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"601\",\"parentId\":\"600\",\"text\":\"小说列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookComment\"},\"checked\":false,\"children\":[]', '127.0.0.1', '2023-07-20 10:34:09');
INSERT INTO `sys_log` VALUES (1447, 1, 'admin', '编辑角色', 5, 'com.java2nb.system.controller.RoleController.edit()', NULL, '127.0.0.1', '2023-07-20 10:58:21');
INSERT INTO `sys_log` VALUES (1448, 1, 'admin', '更新角色', 51, 'com.java2nb.system.controller.RoleController.update()', NULL, '127.0.0.1', '2023-07-20 10:58:29');
INSERT INTO `sys_log` VALUES (1449, 1, 'admin', '删除菜单', 5, 'com.java2nb.system.controller.MenuController.remove()', NULL, '127.0.0.1', '2023-07-20 10:58:41');
INSERT INTO `sys_log` VALUES (1450, 1, 'admin', '请求访问主页', 14, 'com.java2nb.system.controller.LoginController.index()', '{\"menus\":[{\"attributes\":{\"icon\":\"fa fa-bars\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"/common/dict\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"78\",\"parentId\":\"1\",\"text\":\"数据字典\"},{\"attributes\":{\"icon\":\"fa fa-folder-open\",\"url\":\"/common/sysFile\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"71\",\"parentId\":\"1\",\"text\":\"文件管理\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"1\",\"parentId\":\"0\",\"text\":\"基础管理\"},{\"attributes\":{\"icon\":\"fa fa-desktop\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/user/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"6\",\"parentId\":\"3\",\"text\":\"用户管理\"},{\"attributes\":{\"icon\":\"fa fa-paw\",\"url\":\"sys/role\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"7\",\"parentId\":\"3\",\"text\":\"角色管理\"},{\"attributes\":{\"icon\":\"fa fa-th-list\",\"url\":\"sys/menu/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"2\",\"parentId\":\"3\",\"text\":\"系统菜单\"},{\"attributes\":{\"icon\":\"fa fa-users\",\"url\":\"/system/sysDept\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"73\",\"parentId\":\"3\",\"text\":\"部门管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"system/dataPerm\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"209\",\"parentId\":\"3\",\"text\":\"数据权限\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"3\",\"parentId\":\"0\",\"text\":\"系统管理\"},{\"attributes\":{\"icon\":\"fa fa-video-camera\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/online\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"92\",\"parentId\":\"91\",\"text\":\"在线用户\"},{\"attributes\":{\"icon\":\"fa fa-warning\",\"url\":\"common/log\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"27\",\"parentId\":\"91\",\"text\":\"系统日志\"},{\"attributes\":{\"icon\":\"fa fa-caret-square-o-right\",\"url\":\"/druid/index.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"57\",\"parentId\":\"91\",\"text\":\"运行监控\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"91\",\"parentId\":\"0\",\"text\":\"系统监控\"},{\"attributes\":{\"icon\":\"fa fa-gear\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"\",\"url\":\"/swagger-ui.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"104\",\"parentId\":\"77\",\"text\":\"swagger\"},{\"attributes\":{\"icon\":\"fa fa-code\",\"url\":\"common/generator\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"48\",\"parentId\":\"77\",\"text\":\"代码生成\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"77\",\"parentId\":\"0\",\"text\":\"研发工具\"},{\"attributes\":{\"icon\":\"fa fa-television\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookSetting\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"320\",\"parentId\":\"300\",\"text\":\"小说推荐\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/websiteInfo\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"301\",\"parentId\":\"300\",\"text\":\"网站信息\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/friendLink\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"310\",\"parentId\":\"300\",\"text\":\"友情链接\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"300\",\"parentId\":\"0\",\"text\":\"网站管理\"},{\"attributes\":{\"icon\":\"fa fa-newspaper-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/category\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"235\",\"parentId\":\"234\",\"text\":\"类别管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/news\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"241\",\"parentId\":\"234\",\"text\":\"新闻列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"234\",\"parentId\":\"0\",\"text\":\"新闻管理\"},{\"attributes\":{\"icon\":\"fa fa-vcard\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/user\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"401\",\"parentId\":\"400\",\"text\":\"会员列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/userFeedback\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"410\",\"parentId\":\"400\",\"text\":\"会员反馈\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"400\",\"parentId\":\"0\",\"text\":\"会员管理\"},{\"attributes\":{\"icon\":\"fa fa-user-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/authorCode\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"228\",\"parentId\":\"221\",\"text\":\"邀请码管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/author\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"222\",\"parentId\":\"221\",\"text\":\"作者列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"221\",\"parentId\":\"0\",\"text\":\"作家管理\"},{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/book\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"601\",\"parentId\":\"600\",\"text\":\"小说列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookComment\"},\"checked\":false,\"children\":[]', '127.0.0.1', '2023-07-20 10:58:49');
INSERT INTO `sys_log` VALUES (1451, 1, 'admin', '登录', 13, 'com.java2nb.system.controller.LoginController.ajaxLogin()', NULL, '127.0.0.1', '2023-07-20 10:58:59');
INSERT INTO `sys_log` VALUES (1452, 1, 'admin', '请求访问主页', 12, 'com.java2nb.system.controller.LoginController.index()', '{\"menus\":[{\"attributes\":{\"icon\":\"fa fa-bars\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"/common/dict\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"78\",\"parentId\":\"1\",\"text\":\"数据字典\"},{\"attributes\":{\"icon\":\"fa fa-folder-open\",\"url\":\"/common/sysFile\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"71\",\"parentId\":\"1\",\"text\":\"文件管理\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"1\",\"parentId\":\"0\",\"text\":\"基础管理\"},{\"attributes\":{\"icon\":\"fa fa-desktop\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/user/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"6\",\"parentId\":\"3\",\"text\":\"用户管理\"},{\"attributes\":{\"icon\":\"fa fa-paw\",\"url\":\"sys/role\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"7\",\"parentId\":\"3\",\"text\":\"角色管理\"},{\"attributes\":{\"icon\":\"fa fa-th-list\",\"url\":\"sys/menu/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"2\",\"parentId\":\"3\",\"text\":\"系统菜单\"},{\"attributes\":{\"icon\":\"fa fa-users\",\"url\":\"/system/sysDept\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"73\",\"parentId\":\"3\",\"text\":\"部门管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"system/dataPerm\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"209\",\"parentId\":\"3\",\"text\":\"数据权限\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"3\",\"parentId\":\"0\",\"text\":\"系统管理\"},{\"attributes\":{\"icon\":\"fa fa-video-camera\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/online\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"92\",\"parentId\":\"91\",\"text\":\"在线用户\"},{\"attributes\":{\"icon\":\"fa fa-warning\",\"url\":\"common/log\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"27\",\"parentId\":\"91\",\"text\":\"系统日志\"},{\"attributes\":{\"icon\":\"fa fa-caret-square-o-right\",\"url\":\"/druid/index.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"57\",\"parentId\":\"91\",\"text\":\"运行监控\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"91\",\"parentId\":\"0\",\"text\":\"系统监控\"},{\"attributes\":{\"icon\":\"fa fa-gear\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"\",\"url\":\"/swagger-ui.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"104\",\"parentId\":\"77\",\"text\":\"swagger\"},{\"attributes\":{\"icon\":\"fa fa-code\",\"url\":\"common/generator\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"48\",\"parentId\":\"77\",\"text\":\"代码生成\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"77\",\"parentId\":\"0\",\"text\":\"研发工具\"},{\"attributes\":{\"icon\":\"fa fa-television\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookSetting\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"320\",\"parentId\":\"300\",\"text\":\"小说推荐\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/websiteInfo\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"301\",\"parentId\":\"300\",\"text\":\"网站信息\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/friendLink\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"310\",\"parentId\":\"300\",\"text\":\"友情链接\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"300\",\"parentId\":\"0\",\"text\":\"网站管理\"},{\"attributes\":{\"icon\":\"fa fa-newspaper-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/category\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"235\",\"parentId\":\"234\",\"text\":\"类别管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/news\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"241\",\"parentId\":\"234\",\"text\":\"新闻列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"234\",\"parentId\":\"0\",\"text\":\"新闻管理\"},{\"attributes\":{\"icon\":\"fa fa-vcard\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/user\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"401\",\"parentId\":\"400\",\"text\":\"会员列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/userFeedback\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"410\",\"parentId\":\"400\",\"text\":\"会员反馈\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"400\",\"parentId\":\"0\",\"text\":\"会员管理\"},{\"attributes\":{\"icon\":\"fa fa-user-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/authorCode\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"228\",\"parentId\":\"221\",\"text\":\"邀请码管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/author\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"222\",\"parentId\":\"221\",\"text\":\"作者列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"221\",\"parentId\":\"0\",\"text\":\"作家管理\"},{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/book\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"601\",\"parentId\":\"600\",\"text\":\"小说列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookComment\"},\"checked\":false,\"children\":[]', '127.0.0.1', '2023-07-20 10:58:59');
INSERT INTO `sys_log` VALUES (1453, 1, 'admin', '请求访问主页', 15, 'com.java2nb.system.controller.LoginController.index()', '{\"menus\":[{\"attributes\":{\"icon\":\"fa fa-bars\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"/common/dict\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"78\",\"parentId\":\"1\",\"text\":\"数据字典\"},{\"attributes\":{\"icon\":\"fa fa-folder-open\",\"url\":\"/common/sysFile\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"71\",\"parentId\":\"1\",\"text\":\"文件管理\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"1\",\"parentId\":\"0\",\"text\":\"基础管理\"},{\"attributes\":{\"icon\":\"fa fa-desktop\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/user/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"6\",\"parentId\":\"3\",\"text\":\"用户管理\"},{\"attributes\":{\"icon\":\"fa fa-paw\",\"url\":\"sys/role\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"7\",\"parentId\":\"3\",\"text\":\"角色管理\"},{\"attributes\":{\"icon\":\"fa fa-th-list\",\"url\":\"sys/menu/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"2\",\"parentId\":\"3\",\"text\":\"系统菜单\"},{\"attributes\":{\"icon\":\"fa fa-users\",\"url\":\"/system/sysDept\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"73\",\"parentId\":\"3\",\"text\":\"部门管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"system/dataPerm\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"209\",\"parentId\":\"3\",\"text\":\"数据权限\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"3\",\"parentId\":\"0\",\"text\":\"系统管理\"},{\"attributes\":{\"icon\":\"fa fa-video-camera\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/online\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"92\",\"parentId\":\"91\",\"text\":\"在线用户\"},{\"attributes\":{\"icon\":\"fa fa-warning\",\"url\":\"common/log\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"27\",\"parentId\":\"91\",\"text\":\"系统日志\"},{\"attributes\":{\"icon\":\"fa fa-caret-square-o-right\",\"url\":\"/druid/index.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"57\",\"parentId\":\"91\",\"text\":\"运行监控\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"91\",\"parentId\":\"0\",\"text\":\"系统监控\"},{\"attributes\":{\"icon\":\"fa fa-gear\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"\",\"url\":\"/swagger-ui.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"104\",\"parentId\":\"77\",\"text\":\"swagger\"},{\"attributes\":{\"icon\":\"fa fa-code\",\"url\":\"common/generator\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"48\",\"parentId\":\"77\",\"text\":\"代码生成\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"77\",\"parentId\":\"0\",\"text\":\"研发工具\"},{\"attributes\":{\"icon\":\"fa fa-television\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookSetting\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"320\",\"parentId\":\"300\",\"text\":\"小说推荐\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/websiteInfo\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"301\",\"parentId\":\"300\",\"text\":\"网站信息\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/friendLink\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"310\",\"parentId\":\"300\",\"text\":\"友情链接\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"300\",\"parentId\":\"0\",\"text\":\"网站管理\"},{\"attributes\":{\"icon\":\"fa fa-newspaper-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/category\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"235\",\"parentId\":\"234\",\"text\":\"类别管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/news\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"241\",\"parentId\":\"234\",\"text\":\"新闻列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"234\",\"parentId\":\"0\",\"text\":\"新闻管理\"},{\"attributes\":{\"icon\":\"fa fa-vcard\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/user\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"401\",\"parentId\":\"400\",\"text\":\"会员列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/userFeedback\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"410\",\"parentId\":\"400\",\"text\":\"会员反馈\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"400\",\"parentId\":\"0\",\"text\":\"会员管理\"},{\"attributes\":{\"icon\":\"fa fa-user-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/authorCode\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"228\",\"parentId\":\"221\",\"text\":\"邀请码管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/author\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"222\",\"parentId\":\"221\",\"text\":\"作者列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"221\",\"parentId\":\"0\",\"text\":\"作家管理\"},{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/book\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"601\",\"parentId\":\"600\",\"text\":\"小说列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookComment\"},\"checked\":false,\"children\":[]', '127.0.0.1', '2023-07-20 11:22:53');
INSERT INTO `sys_log` VALUES (1454, 1, 'admin', '登录', 24, 'com.java2nb.system.controller.LoginController.ajaxLogin()', NULL, '127.0.0.1', '2023-07-20 14:16:10');
INSERT INTO `sys_log` VALUES (1455, 1, 'admin', '请求访问主页', 13, 'com.java2nb.system.controller.LoginController.index()', '{\"menus\":[{\"attributes\":{\"icon\":\"fa fa-bars\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"/common/dict\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"78\",\"parentId\":\"1\",\"text\":\"数据字典\"},{\"attributes\":{\"icon\":\"fa fa-folder-open\",\"url\":\"/common/sysFile\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"71\",\"parentId\":\"1\",\"text\":\"文件管理\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"1\",\"parentId\":\"0\",\"text\":\"基础管理\"},{\"attributes\":{\"icon\":\"fa fa-desktop\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/user/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"6\",\"parentId\":\"3\",\"text\":\"用户管理\"},{\"attributes\":{\"icon\":\"fa fa-paw\",\"url\":\"sys/role\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"7\",\"parentId\":\"3\",\"text\":\"角色管理\"},{\"attributes\":{\"icon\":\"fa fa-th-list\",\"url\":\"sys/menu/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"2\",\"parentId\":\"3\",\"text\":\"系统菜单\"},{\"attributes\":{\"icon\":\"fa fa-users\",\"url\":\"/system/sysDept\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"73\",\"parentId\":\"3\",\"text\":\"部门管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"system/dataPerm\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"209\",\"parentId\":\"3\",\"text\":\"数据权限\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"3\",\"parentId\":\"0\",\"text\":\"系统管理\"},{\"attributes\":{\"icon\":\"fa fa-video-camera\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/online\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"92\",\"parentId\":\"91\",\"text\":\"在线用户\"},{\"attributes\":{\"icon\":\"fa fa-warning\",\"url\":\"common/log\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"27\",\"parentId\":\"91\",\"text\":\"系统日志\"},{\"attributes\":{\"icon\":\"fa fa-caret-square-o-right\",\"url\":\"/druid/index.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"57\",\"parentId\":\"91\",\"text\":\"运行监控\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"91\",\"parentId\":\"0\",\"text\":\"系统监控\"},{\"attributes\":{\"icon\":\"fa fa-gear\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"\",\"url\":\"/swagger-ui.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"104\",\"parentId\":\"77\",\"text\":\"swagger\"},{\"attributes\":{\"icon\":\"fa fa-code\",\"url\":\"common/generator\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"48\",\"parentId\":\"77\",\"text\":\"代码生成\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"77\",\"parentId\":\"0\",\"text\":\"研发工具\"},{\"attributes\":{\"icon\":\"fa fa-television\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookSetting\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"320\",\"parentId\":\"300\",\"text\":\"小说推荐\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/websiteInfo\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"301\",\"parentId\":\"300\",\"text\":\"网站信息\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/friendLink\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"310\",\"parentId\":\"300\",\"text\":\"友情链接\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"300\",\"parentId\":\"0\",\"text\":\"网站管理\"},{\"attributes\":{\"icon\":\"fa fa-newspaper-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/category\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"235\",\"parentId\":\"234\",\"text\":\"类别管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/news\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"241\",\"parentId\":\"234\",\"text\":\"新闻列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"234\",\"parentId\":\"0\",\"text\":\"新闻管理\"},{\"attributes\":{\"icon\":\"fa fa-vcard\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/user\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"401\",\"parentId\":\"400\",\"text\":\"会员列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/userFeedback\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"410\",\"parentId\":\"400\",\"text\":\"会员反馈\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"400\",\"parentId\":\"0\",\"text\":\"会员管理\"},{\"attributes\":{\"icon\":\"fa fa-user-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/authorCode\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"228\",\"parentId\":\"221\",\"text\":\"邀请码管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/author\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"222\",\"parentId\":\"221\",\"text\":\"作者列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"221\",\"parentId\":\"0\",\"text\":\"作家管理\"},{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/book\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"601\",\"parentId\":\"600\",\"text\":\"小说列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookComment\"},\"checked\":false,\"children\":[]', '127.0.0.1', '2023-07-20 14:16:10');
INSERT INTO `sys_log` VALUES (1456, 1, 'admin', '请求访问主页', 11, 'com.java2nb.system.controller.LoginController.index()', '{\"menus\":[{\"attributes\":{\"icon\":\"fa fa-bars\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"/common/dict\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"78\",\"parentId\":\"1\",\"text\":\"数据字典\"},{\"attributes\":{\"icon\":\"fa fa-folder-open\",\"url\":\"/common/sysFile\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"71\",\"parentId\":\"1\",\"text\":\"文件管理\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"1\",\"parentId\":\"0\",\"text\":\"基础管理\"},{\"attributes\":{\"icon\":\"fa fa-desktop\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/user/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"6\",\"parentId\":\"3\",\"text\":\"用户管理\"},{\"attributes\":{\"icon\":\"fa fa-paw\",\"url\":\"sys/role\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"7\",\"parentId\":\"3\",\"text\":\"角色管理\"},{\"attributes\":{\"icon\":\"fa fa-th-list\",\"url\":\"sys/menu/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"2\",\"parentId\":\"3\",\"text\":\"系统菜单\"},{\"attributes\":{\"icon\":\"fa fa-users\",\"url\":\"/system/sysDept\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"73\",\"parentId\":\"3\",\"text\":\"部门管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"system/dataPerm\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"209\",\"parentId\":\"3\",\"text\":\"数据权限\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"3\",\"parentId\":\"0\",\"text\":\"系统管理\"},{\"attributes\":{\"icon\":\"fa fa-video-camera\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/online\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"92\",\"parentId\":\"91\",\"text\":\"在线用户\"},{\"attributes\":{\"icon\":\"fa fa-warning\",\"url\":\"common/log\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"27\",\"parentId\":\"91\",\"text\":\"系统日志\"},{\"attributes\":{\"icon\":\"fa fa-caret-square-o-right\",\"url\":\"/druid/index.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"57\",\"parentId\":\"91\",\"text\":\"运行监控\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"91\",\"parentId\":\"0\",\"text\":\"系统监控\"},{\"attributes\":{\"icon\":\"fa fa-gear\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"\",\"url\":\"/swagger-ui.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"104\",\"parentId\":\"77\",\"text\":\"swagger\"},{\"attributes\":{\"icon\":\"fa fa-code\",\"url\":\"common/generator\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"48\",\"parentId\":\"77\",\"text\":\"代码生成\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"77\",\"parentId\":\"0\",\"text\":\"研发工具\"},{\"attributes\":{\"icon\":\"fa fa-television\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookSetting\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"320\",\"parentId\":\"300\",\"text\":\"小说推荐\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/websiteInfo\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"301\",\"parentId\":\"300\",\"text\":\"网站信息\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/friendLink\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"310\",\"parentId\":\"300\",\"text\":\"友情链接\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"300\",\"parentId\":\"0\",\"text\":\"网站管理\"},{\"attributes\":{\"icon\":\"fa fa-newspaper-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/category\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"235\",\"parentId\":\"234\",\"text\":\"类别管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/news\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"241\",\"parentId\":\"234\",\"text\":\"新闻列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"234\",\"parentId\":\"0\",\"text\":\"新闻管理\"},{\"attributes\":{\"icon\":\"fa fa-vcard\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/user\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"401\",\"parentId\":\"400\",\"text\":\"会员列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/userFeedback\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"410\",\"parentId\":\"400\",\"text\":\"会员反馈\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"400\",\"parentId\":\"0\",\"text\":\"会员管理\"},{\"attributes\":{\"icon\":\"fa fa-user-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/authorCode\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"228\",\"parentId\":\"221\",\"text\":\"邀请码管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/author\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"222\",\"parentId\":\"221\",\"text\":\"作者列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"221\",\"parentId\":\"0\",\"text\":\"作家管理\"},{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/book\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"601\",\"parentId\":\"600\",\"text\":\"小说列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookComment\"},\"checked\":false,\"children\":[]', '127.0.0.1', '2023-07-20 14:17:50');
INSERT INTO `sys_log` VALUES (1457, 1, 'admin', '登录', 8, 'com.java2nb.system.controller.LoginController.ajaxLogin()', NULL, '127.0.0.1', '2023-07-20 14:20:10');
INSERT INTO `sys_log` VALUES (1458, 1, 'admin', '请求访问主页', 13, 'com.java2nb.system.controller.LoginController.index()', '{\"menus\":[{\"attributes\":{\"icon\":\"fa fa-bars\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"/common/dict\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"78\",\"parentId\":\"1\",\"text\":\"数据字典\"},{\"attributes\":{\"icon\":\"fa fa-folder-open\",\"url\":\"/common/sysFile\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"71\",\"parentId\":\"1\",\"text\":\"文件管理\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"1\",\"parentId\":\"0\",\"text\":\"基础管理\"},{\"attributes\":{\"icon\":\"fa fa-desktop\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/user/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"6\",\"parentId\":\"3\",\"text\":\"用户管理\"},{\"attributes\":{\"icon\":\"fa fa-paw\",\"url\":\"sys/role\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"7\",\"parentId\":\"3\",\"text\":\"角色管理\"},{\"attributes\":{\"icon\":\"fa fa-th-list\",\"url\":\"sys/menu/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"2\",\"parentId\":\"3\",\"text\":\"系统菜单\"},{\"attributes\":{\"icon\":\"fa fa-users\",\"url\":\"/system/sysDept\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"73\",\"parentId\":\"3\",\"text\":\"部门管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"system/dataPerm\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"209\",\"parentId\":\"3\",\"text\":\"数据权限\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"3\",\"parentId\":\"0\",\"text\":\"系统管理\"},{\"attributes\":{\"icon\":\"fa fa-video-camera\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/online\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"92\",\"parentId\":\"91\",\"text\":\"在线用户\"},{\"attributes\":{\"icon\":\"fa fa-warning\",\"url\":\"common/log\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"27\",\"parentId\":\"91\",\"text\":\"系统日志\"},{\"attributes\":{\"icon\":\"fa fa-caret-square-o-right\",\"url\":\"/druid/index.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"57\",\"parentId\":\"91\",\"text\":\"运行监控\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"91\",\"parentId\":\"0\",\"text\":\"系统监控\"},{\"attributes\":{\"icon\":\"fa fa-gear\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"\",\"url\":\"/swagger-ui.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"104\",\"parentId\":\"77\",\"text\":\"swagger\"},{\"attributes\":{\"icon\":\"fa fa-code\",\"url\":\"common/generator\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"48\",\"parentId\":\"77\",\"text\":\"代码生成\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"77\",\"parentId\":\"0\",\"text\":\"研发工具\"},{\"attributes\":{\"icon\":\"fa fa-television\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookSetting\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"320\",\"parentId\":\"300\",\"text\":\"小说推荐\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/websiteInfo\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"301\",\"parentId\":\"300\",\"text\":\"网站信息\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/friendLink\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"310\",\"parentId\":\"300\",\"text\":\"友情链接\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"300\",\"parentId\":\"0\",\"text\":\"网站管理\"},{\"attributes\":{\"icon\":\"fa fa-newspaper-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/category\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"235\",\"parentId\":\"234\",\"text\":\"类别管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/news\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"241\",\"parentId\":\"234\",\"text\":\"新闻列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"234\",\"parentId\":\"0\",\"text\":\"新闻管理\"},{\"attributes\":{\"icon\":\"fa fa-vcard\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/user\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"401\",\"parentId\":\"400\",\"text\":\"会员列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/userFeedback\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"410\",\"parentId\":\"400\",\"text\":\"会员反馈\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"400\",\"parentId\":\"0\",\"text\":\"会员管理\"},{\"attributes\":{\"icon\":\"fa fa-user-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/authorCode\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"228\",\"parentId\":\"221\",\"text\":\"邀请码管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/author\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"222\",\"parentId\":\"221\",\"text\":\"作者列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"221\",\"parentId\":\"0\",\"text\":\"作家管理\"},{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/book\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"601\",\"parentId\":\"600\",\"text\":\"小说列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookComment\"},\"checked\":false,\"children\":[]', '127.0.0.1', '2023-07-20 14:20:10');
INSERT INTO `sys_log` VALUES (1459, 1, 'admin', '请求访问主页', 113, 'com.java2nb.system.controller.LoginController.index()', '{\"menus\":[{\"attributes\":{\"icon\":\"fa fa-bars\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"/common/dict\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"78\",\"parentId\":\"1\",\"text\":\"数据字典\"},{\"attributes\":{\"icon\":\"fa fa-folder-open\",\"url\":\"/common/sysFile\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"71\",\"parentId\":\"1\",\"text\":\"文件管理\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"1\",\"parentId\":\"0\",\"text\":\"基础管理\"},{\"attributes\":{\"icon\":\"fa fa-desktop\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/user/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"6\",\"parentId\":\"3\",\"text\":\"用户管理\"},{\"attributes\":{\"icon\":\"fa fa-paw\",\"url\":\"sys/role\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"7\",\"parentId\":\"3\",\"text\":\"角色管理\"},{\"attributes\":{\"icon\":\"fa fa-th-list\",\"url\":\"sys/menu/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"2\",\"parentId\":\"3\",\"text\":\"系统菜单\"},{\"attributes\":{\"icon\":\"fa fa-users\",\"url\":\"/system/sysDept\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"73\",\"parentId\":\"3\",\"text\":\"部门管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"system/dataPerm\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"209\",\"parentId\":\"3\",\"text\":\"数据权限\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"3\",\"parentId\":\"0\",\"text\":\"系统管理\"},{\"attributes\":{\"icon\":\"fa fa-video-camera\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/online\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"92\",\"parentId\":\"91\",\"text\":\"在线用户\"},{\"attributes\":{\"icon\":\"fa fa-warning\",\"url\":\"common/log\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"27\",\"parentId\":\"91\",\"text\":\"系统日志\"},{\"attributes\":{\"icon\":\"fa fa-caret-square-o-right\",\"url\":\"/druid/index.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"57\",\"parentId\":\"91\",\"text\":\"运行监控\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"91\",\"parentId\":\"0\",\"text\":\"系统监控\"},{\"attributes\":{\"icon\":\"fa fa-gear\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"\",\"url\":\"/swagger-ui.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"104\",\"parentId\":\"77\",\"text\":\"swagger\"},{\"attributes\":{\"icon\":\"fa fa-code\",\"url\":\"common/generator\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"48\",\"parentId\":\"77\",\"text\":\"代码生成\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"77\",\"parentId\":\"0\",\"text\":\"研发工具\"},{\"attributes\":{\"icon\":\"fa fa-television\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookSetting\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"320\",\"parentId\":\"300\",\"text\":\"小说推荐\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/websiteInfo\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"301\",\"parentId\":\"300\",\"text\":\"网站信息\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/friendLink\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"310\",\"parentId\":\"300\",\"text\":\"友情链接\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"300\",\"parentId\":\"0\",\"text\":\"网站管理\"},{\"attributes\":{\"icon\":\"fa fa-newspaper-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/category\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"235\",\"parentId\":\"234\",\"text\":\"类别管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/news\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"241\",\"parentId\":\"234\",\"text\":\"新闻列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"234\",\"parentId\":\"0\",\"text\":\"新闻管理\"},{\"attributes\":{\"icon\":\"fa fa-vcard\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/user\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"401\",\"parentId\":\"400\",\"text\":\"会员列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/userFeedback\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"410\",\"parentId\":\"400\",\"text\":\"会员反馈\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"400\",\"parentId\":\"0\",\"text\":\"会员管理\"},{\"attributes\":{\"icon\":\"fa fa-user-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/authorCode\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"228\",\"parentId\":\"221\",\"text\":\"邀请码管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/author\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"222\",\"parentId\":\"221\",\"text\":\"作者列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"221\",\"parentId\":\"0\",\"text\":\"作家管理\"},{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/book\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"601\",\"parentId\":\"600\",\"text\":\"小说列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookComment\"},\"checked\":false,\"children\":[]', '127.0.0.1', '2023-07-20 14:32:10');
INSERT INTO `sys_log` VALUES (1460, 1, 'admin', '登录', 199, 'com.java2nb.system.controller.LoginController.ajaxLogin()', NULL, '127.0.0.1', '2023-07-20 15:00:04');
INSERT INTO `sys_log` VALUES (1461, 1, 'admin', '请求访问主页', 32, 'com.java2nb.system.controller.LoginController.index()', '{\"menus\":[{\"attributes\":{\"icon\":\"fa fa-bars\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"/common/dict\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"78\",\"parentId\":\"1\",\"text\":\"数据字典\"},{\"attributes\":{\"icon\":\"fa fa-folder-open\",\"url\":\"/common/sysFile\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"71\",\"parentId\":\"1\",\"text\":\"文件管理\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"1\",\"parentId\":\"0\",\"text\":\"基础管理\"},{\"attributes\":{\"icon\":\"fa fa-desktop\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/user/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"6\",\"parentId\":\"3\",\"text\":\"用户管理\"},{\"attributes\":{\"icon\":\"fa fa-paw\",\"url\":\"sys/role\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"7\",\"parentId\":\"3\",\"text\":\"角色管理\"},{\"attributes\":{\"icon\":\"fa fa-th-list\",\"url\":\"sys/menu/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"2\",\"parentId\":\"3\",\"text\":\"系统菜单\"},{\"attributes\":{\"icon\":\"fa fa-users\",\"url\":\"/system/sysDept\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"73\",\"parentId\":\"3\",\"text\":\"部门管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"system/dataPerm\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"209\",\"parentId\":\"3\",\"text\":\"数据权限\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"3\",\"parentId\":\"0\",\"text\":\"系统管理\"},{\"attributes\":{\"icon\":\"fa fa-video-camera\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/online\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"92\",\"parentId\":\"91\",\"text\":\"在线用户\"},{\"attributes\":{\"icon\":\"fa fa-warning\",\"url\":\"common/log\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"27\",\"parentId\":\"91\",\"text\":\"系统日志\"},{\"attributes\":{\"icon\":\"fa fa-caret-square-o-right\",\"url\":\"/druid/index.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"57\",\"parentId\":\"91\",\"text\":\"运行监控\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"91\",\"parentId\":\"0\",\"text\":\"系统监控\"},{\"attributes\":{\"icon\":\"fa fa-gear\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"\",\"url\":\"/swagger-ui.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"104\",\"parentId\":\"77\",\"text\":\"swagger\"},{\"attributes\":{\"icon\":\"fa fa-code\",\"url\":\"common/generator\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"48\",\"parentId\":\"77\",\"text\":\"代码生成\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"77\",\"parentId\":\"0\",\"text\":\"研发工具\"},{\"attributes\":{\"icon\":\"fa fa-television\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookSetting\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"320\",\"parentId\":\"300\",\"text\":\"小说推荐\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/websiteInfo\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"301\",\"parentId\":\"300\",\"text\":\"网站信息\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/friendLink\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"310\",\"parentId\":\"300\",\"text\":\"友情链接\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"300\",\"parentId\":\"0\",\"text\":\"网站管理\"},{\"attributes\":{\"icon\":\"fa fa-newspaper-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/category\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"235\",\"parentId\":\"234\",\"text\":\"类别管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/news\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"241\",\"parentId\":\"234\",\"text\":\"新闻列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"234\",\"parentId\":\"0\",\"text\":\"新闻管理\"},{\"attributes\":{\"icon\":\"fa fa-vcard\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/user\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"401\",\"parentId\":\"400\",\"text\":\"会员列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/userFeedback\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"410\",\"parentId\":\"400\",\"text\":\"会员反馈\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"400\",\"parentId\":\"0\",\"text\":\"会员管理\"},{\"attributes\":{\"icon\":\"fa fa-user-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/authorCode\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"228\",\"parentId\":\"221\",\"text\":\"邀请码管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/author\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"222\",\"parentId\":\"221\",\"text\":\"作者列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"221\",\"parentId\":\"0\",\"text\":\"作家管理\"},{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/book\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"601\",\"parentId\":\"600\",\"text\":\"小说列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookComment\"},\"checked\":false,\"children\":[]', '127.0.0.1', '2023-07-20 15:00:04');
INSERT INTO `sys_log` VALUES (1462, 1, 'admin', '请求访问主页', 189, 'com.java2nb.system.controller.LoginController.index()', '{\"menus\":[{\"attributes\":{\"icon\":\"fa fa-bars\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"/common/dict\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"78\",\"parentId\":\"1\",\"text\":\"数据字典\"},{\"attributes\":{\"icon\":\"fa fa-folder-open\",\"url\":\"/common/sysFile\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"71\",\"parentId\":\"1\",\"text\":\"文件管理\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"1\",\"parentId\":\"0\",\"text\":\"基础管理\"},{\"attributes\":{\"icon\":\"fa fa-desktop\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/user/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"6\",\"parentId\":\"3\",\"text\":\"用户管理\"},{\"attributes\":{\"icon\":\"fa fa-paw\",\"url\":\"sys/role\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"7\",\"parentId\":\"3\",\"text\":\"角色管理\"},{\"attributes\":{\"icon\":\"fa fa-th-list\",\"url\":\"sys/menu/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"2\",\"parentId\":\"3\",\"text\":\"系统菜单\"},{\"attributes\":{\"icon\":\"fa fa-users\",\"url\":\"/system/sysDept\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"73\",\"parentId\":\"3\",\"text\":\"部门管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"system/dataPerm\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"209\",\"parentId\":\"3\",\"text\":\"数据权限\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"3\",\"parentId\":\"0\",\"text\":\"系统管理\"},{\"attributes\":{\"icon\":\"fa fa-video-camera\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/online\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"92\",\"parentId\":\"91\",\"text\":\"在线用户\"},{\"attributes\":{\"icon\":\"fa fa-warning\",\"url\":\"common/log\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"27\",\"parentId\":\"91\",\"text\":\"系统日志\"},{\"attributes\":{\"icon\":\"fa fa-caret-square-o-right\",\"url\":\"/druid/index.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"57\",\"parentId\":\"91\",\"text\":\"运行监控\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"91\",\"parentId\":\"0\",\"text\":\"系统监控\"},{\"attributes\":{\"icon\":\"fa fa-gear\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"\",\"url\":\"/swagger-ui.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"104\",\"parentId\":\"77\",\"text\":\"swagger\"},{\"attributes\":{\"icon\":\"fa fa-code\",\"url\":\"common/generator\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"48\",\"parentId\":\"77\",\"text\":\"代码生成\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"77\",\"parentId\":\"0\",\"text\":\"研发工具\"},{\"attributes\":{\"icon\":\"fa fa-television\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookSetting\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"320\",\"parentId\":\"300\",\"text\":\"小说推荐\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/websiteInfo\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"301\",\"parentId\":\"300\",\"text\":\"网站信息\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/friendLink\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"310\",\"parentId\":\"300\",\"text\":\"友情链接\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"300\",\"parentId\":\"0\",\"text\":\"网站管理\"},{\"attributes\":{\"icon\":\"fa fa-newspaper-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/category\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"235\",\"parentId\":\"234\",\"text\":\"类别管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/news\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"241\",\"parentId\":\"234\",\"text\":\"新闻列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"234\",\"parentId\":\"0\",\"text\":\"新闻管理\"},{\"attributes\":{\"icon\":\"fa fa-vcard\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/user\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"401\",\"parentId\":\"400\",\"text\":\"会员列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/userFeedback\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"410\",\"parentId\":\"400\",\"text\":\"会员反馈\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"400\",\"parentId\":\"0\",\"text\":\"会员管理\"},{\"attributes\":{\"icon\":\"fa fa-user-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/authorCode\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"228\",\"parentId\":\"221\",\"text\":\"邀请码管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/author\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"222\",\"parentId\":\"221\",\"text\":\"作者列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"221\",\"parentId\":\"0\",\"text\":\"作家管理\"},{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/book\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"601\",\"parentId\":\"600\",\"text\":\"小说列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookComment\"},\"checked\":false,\"children\":[]', '127.0.0.1', '2023-07-20 15:01:53');
INSERT INTO `sys_log` VALUES (1463, 1, 'admin', '编辑角色', 4, 'com.java2nb.system.controller.RoleController.edit()', NULL, '127.0.0.1', '2023-07-20 15:06:24');
INSERT INTO `sys_log` VALUES (1464, 1, 'admin', '登录', 33, 'com.java2nb.system.controller.LoginController.ajaxLogin()', NULL, '127.0.0.1', '2023-07-20 17:00:15');
INSERT INTO `sys_log` VALUES (1465, 1, 'admin', '请求访问主页', 10, 'com.java2nb.system.controller.LoginController.index()', '{\"menus\":[{\"attributes\":{\"icon\":\"fa fa-bars\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"/common/dict\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"78\",\"parentId\":\"1\",\"text\":\"数据字典\"},{\"attributes\":{\"icon\":\"fa fa-folder-open\",\"url\":\"/common/sysFile\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"71\",\"parentId\":\"1\",\"text\":\"文件管理\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"1\",\"parentId\":\"0\",\"text\":\"基础管理\"},{\"attributes\":{\"icon\":\"fa fa-desktop\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/user/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"6\",\"parentId\":\"3\",\"text\":\"用户管理\"},{\"attributes\":{\"icon\":\"fa fa-paw\",\"url\":\"sys/role\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"7\",\"parentId\":\"3\",\"text\":\"角色管理\"},{\"attributes\":{\"icon\":\"fa fa-th-list\",\"url\":\"sys/menu/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"2\",\"parentId\":\"3\",\"text\":\"系统菜单\"},{\"attributes\":{\"icon\":\"fa fa-users\",\"url\":\"/system/sysDept\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"73\",\"parentId\":\"3\",\"text\":\"部门管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"system/dataPerm\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"209\",\"parentId\":\"3\",\"text\":\"数据权限\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"3\",\"parentId\":\"0\",\"text\":\"系统管理\"},{\"attributes\":{\"icon\":\"fa fa-video-camera\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/online\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"92\",\"parentId\":\"91\",\"text\":\"在线用户\"},{\"attributes\":{\"icon\":\"fa fa-warning\",\"url\":\"common/log\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"27\",\"parentId\":\"91\",\"text\":\"系统日志\"},{\"attributes\":{\"icon\":\"fa fa-caret-square-o-right\",\"url\":\"/druid/index.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"57\",\"parentId\":\"91\",\"text\":\"运行监控\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"91\",\"parentId\":\"0\",\"text\":\"系统监控\"},{\"attributes\":{\"icon\":\"fa fa-gear\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"\",\"url\":\"/swagger-ui.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"104\",\"parentId\":\"77\",\"text\":\"swagger\"},{\"attributes\":{\"icon\":\"fa fa-code\",\"url\":\"common/generator\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"48\",\"parentId\":\"77\",\"text\":\"代码生成\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"77\",\"parentId\":\"0\",\"text\":\"研发工具\"},{\"attributes\":{\"icon\":\"fa fa-television\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/websiteInfo\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"301\",\"parentId\":\"300\",\"text\":\"网站信息\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookSetting\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"320\",\"parentId\":\"300\",\"text\":\"小说推荐\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/friendLink\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"310\",\"parentId\":\"300\",\"text\":\"友情链接\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"300\",\"parentId\":\"0\",\"text\":\"网站管理\"},{\"attributes\":{\"icon\":\"fa fa-newspaper-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/category\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"235\",\"parentId\":\"234\",\"text\":\"类别管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/news\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"241\",\"parentId\":\"234\",\"text\":\"新闻列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"234\",\"parentId\":\"0\",\"text\":\"新闻管理\"},{\"attributes\":{\"icon\":\"fa fa-vcard\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/user\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"401\",\"parentId\":\"400\",\"text\":\"会员列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/userFeedback\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"410\",\"parentId\":\"400\",\"text\":\"会员反馈\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"400\",\"parentId\":\"0\",\"text\":\"会员管理\"},{\"attributes\":{\"icon\":\"fa fa-user-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/authorCode\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"228\",\"parentId\":\"221\",\"text\":\"邀请码管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/author\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"222\",\"parentId\":\"221\",\"text\":\"作者列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"221\",\"parentId\":\"0\",\"text\":\"作家管理\"},{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/book\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"601\",\"parentId\":\"600\",\"text\":\"小说列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookComment\"},\"checked\":false,\"children\":[]', '127.0.0.1', '2023-07-20 17:00:15');
INSERT INTO `sys_log` VALUES (1466, 1, 'admin', '登录', 17, 'com.java2nb.system.controller.LoginController.ajaxLogin()', NULL, '127.0.0.1', '2023-07-20 17:09:07');
INSERT INTO `sys_log` VALUES (1467, 1, 'admin', '请求访问主页', 13, 'com.java2nb.system.controller.LoginController.index()', '{\"menus\":[{\"attributes\":{\"icon\":\"fa fa-bars\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"/common/dict\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"78\",\"parentId\":\"1\",\"text\":\"数据字典\"},{\"attributes\":{\"icon\":\"fa fa-folder-open\",\"url\":\"/common/sysFile\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"71\",\"parentId\":\"1\",\"text\":\"文件管理\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"1\",\"parentId\":\"0\",\"text\":\"基础管理\"},{\"attributes\":{\"icon\":\"fa fa-desktop\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/user/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"6\",\"parentId\":\"3\",\"text\":\"用户管理\"},{\"attributes\":{\"icon\":\"fa fa-paw\",\"url\":\"sys/role\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"7\",\"parentId\":\"3\",\"text\":\"角色管理\"},{\"attributes\":{\"icon\":\"fa fa-th-list\",\"url\":\"sys/menu/\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"2\",\"parentId\":\"3\",\"text\":\"系统菜单\"},{\"attributes\":{\"icon\":\"fa fa-users\",\"url\":\"/system/sysDept\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"73\",\"parentId\":\"3\",\"text\":\"部门管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"system/dataPerm\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"209\",\"parentId\":\"3\",\"text\":\"数据权限\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"3\",\"parentId\":\"0\",\"text\":\"系统管理\"},{\"attributes\":{\"icon\":\"fa fa-video-camera\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa fa-user\",\"url\":\"sys/online\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"92\",\"parentId\":\"91\",\"text\":\"在线用户\"},{\"attributes\":{\"icon\":\"fa fa-warning\",\"url\":\"common/log\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"27\",\"parentId\":\"91\",\"text\":\"系统日志\"},{\"attributes\":{\"icon\":\"fa fa-caret-square-o-right\",\"url\":\"/druid/index.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"57\",\"parentId\":\"91\",\"text\":\"运行监控\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"91\",\"parentId\":\"0\",\"text\":\"系统监控\"},{\"attributes\":{\"icon\":\"fa fa-gear\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"\",\"url\":\"/swagger-ui.html\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"104\",\"parentId\":\"77\",\"text\":\"swagger\"},{\"attributes\":{\"icon\":\"fa fa-code\",\"url\":\"common/generator\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"48\",\"parentId\":\"77\",\"text\":\"代码生成\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"77\",\"parentId\":\"0\",\"text\":\"研发工具\"},{\"attributes\":{\"icon\":\"fa fa-television\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookSetting\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"320\",\"parentId\":\"300\",\"text\":\"小说推荐\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/websiteInfo\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"301\",\"parentId\":\"300\",\"text\":\"网站信息\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/friendLink\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"310\",\"parentId\":\"300\",\"text\":\"友情链接\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"300\",\"parentId\":\"0\",\"text\":\"网站管理\"},{\"attributes\":{\"icon\":\"fa fa-newspaper-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/category\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"235\",\"parentId\":\"234\",\"text\":\"类别管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/news\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"241\",\"parentId\":\"234\",\"text\":\"新闻列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"234\",\"parentId\":\"0\",\"text\":\"新闻管理\"},{\"attributes\":{\"icon\":\"fa fa-vcard\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/user\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"401\",\"parentId\":\"400\",\"text\":\"会员列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/userFeedback\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"410\",\"parentId\":\"400\",\"text\":\"会员反馈\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"400\",\"parentId\":\"0\",\"text\":\"会员管理\"},{\"attributes\":{\"icon\":\"fa fa-user-o\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/authorCode\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"228\",\"parentId\":\"221\",\"text\":\"邀请码管理\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/author\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"222\",\"parentId\":\"221\",\"text\":\"作者列表\"}],\"hasChildren\":true,\"hasParent\":false,\"id\":\"221\",\"parentId\":\"0\",\"text\":\"作家管理\"},{\"attributes\":{\"icon\":\"fa fa-book\",\"url\":\"\"},\"checked\":false,\"children\":[{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/book\"},\"checked\":false,\"children\":[],\"hasChildren\":false,\"hasParent\":true,\"id\":\"601\",\"parentId\":\"600\",\"text\":\"小说列表\"},{\"attributes\":{\"icon\":\"fa\",\"url\":\"novel/bookComment\"},\"checked\":false,\"children\":[]', '127.0.0.1', '2023-07-20 17:09:07');
INSERT INTO `sys_log` VALUES (1468, 1, 'admin', '编辑用户', 16, 'com.java2nb.system.controller.SysUserController.edit()', NULL, '127.0.0.1', '2023-07-20 17:09:21');
INSERT INTO `sys_log` VALUES (1469, 1, 'admin', '编辑角色', 4, 'com.java2nb.system.controller.RoleController.edit()', NULL, '127.0.0.1', '2023-07-20 17:09:28');
INSERT INTO `sys_log` VALUES (1470, 1, 'admin', '添加菜单', 1, 'com.java2nb.system.controller.MenuController.add()', NULL, '127.0.0.1', '2023-07-20 17:09:38');
INSERT INTO `sys_log` VALUES (1471, 1, 'admin', '更新用户', 16, 'com.java2nb.system.controller.SysUserController.updatePeronal()', NULL, '127.0.0.1', '2023-07-20 17:12:20');
...
) ENGINE = InnoDB AUTO_INCREMENT = 608 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '菜单管理' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_menu` VALUES (300, 0, '网站管理', '', '', 0, 'fa fa-television', 6, NULL, NULL);
INSERT INTO `sys_menu` VALUES (301, 300, '网站信息', 'novel/websiteInfo', 'novel:websiteInfo:websiteInfo', 1, 'fa', 6, NULL, NULL);
INSERT INTO `sys_menu` VALUES (305, 301, '修改', NULL, 'novel:websiteInfo:edit', 2, NULL, 6, NULL, NULL);
INSERT INTO `sys_menu` VALUES (310, 300, '友情链接', 'novel/friendLink', 'novel:friendLink:friendLink', 1, 'fa', 16, NULL, NULL);
INSERT INTO `sys_menu` VALUES (311, 310, '查看', NULL, 'novel:friendLink:detail', 2, NULL, 6, NULL, NULL);
INSERT INTO `sys_menu` VALUES (312, 310, '新增', NULL, 'novel:friendLink:add', 2, NULL, 6, NULL, NULL);
INSERT INTO `sys_menu` VALUES (313, 310, '修改', NULL, 'novel:friendLink:edit', 2, NULL, 6, NULL, NULL);
INSERT INTO `sys_menu` VALUES (314, 310, '删除', NULL, 'novel:friendLink:remove', 2, NULL, 6, NULL, NULL);
INSERT INTO `sys_menu` VALUES (315, 310, '批量删除', NULL, 'novel:friendLink:batchRemove', 2, NULL, 6, NULL, NULL);
INSERT INTO `sys_menu` VALUES (320, 300, '小说推荐', 'novel/bookSetting', 'novel:bookSetting:bookSetting', 1, 'fa', 6, NULL, NULL);
INSERT INTO `sys_menu` VALUES (321, 320, '查看', NULL, 'novel:bookSetting:detail', 2, NULL, 6, NULL, NULL);
INSERT INTO `sys_menu` VALUES (322, 320, '新增', NULL, 'novel:bookSetting:add', 2, NULL, 6, NULL, NULL);
INSERT INTO `sys_menu` VALUES (323, 320, '修改', NULL, 'novel:bookSetting:edit', 2, NULL, 6, NULL, NULL);
INSERT INTO `sys_menu` VALUES (324, 320, '删除', NULL, 'novel:bookSetting:remove', 2, NULL, 6, NULL, NULL);
INSERT INTO `sys_menu` VALUES (325, 320, '批量删除', NULL, 'novel:bookSetting:batchRemove', 2, NULL, 6, NULL, NULL);
INSERT INTO `sys_menu` VALUES (400, 0, '会员管理', '', '', 0, 'fa fa-vcard', 9, NULL, NULL);
INSERT INTO `sys_menu` VALUES (401, 400, '会员列表', 'novel/user', 'novel:user:user', 1, 'fa', 6, NULL, NULL);
INSERT INTO `sys_menu` VALUES (410, 400, '会员反馈', 'novel/userFeedback', 'novel:userFeedback:userFeedback', 1, 'fa', 16, NULL, NULL);
INSERT INTO `sys_menu` VALUES (500, 0, '订单管理', '', '', 0, 'fa fa-money', 19, NULL, NULL);
INSERT INTO `sys_menu` VALUES (501, 500, '订单列表', 'novel/pay', 'novel:pay:pay', 1, 'fa', 6, NULL, NULL);
INSERT INTO `sys_menu` VALUES (600, 0, '小说管理', '', '', 0, 'fa fa-book', 15, NULL, NULL);
INSERT INTO `sys_menu` VALUES (601, 600, '小说列表', 'novel/book', 'novel:book:book', 1, 'fa', 6, NULL, NULL);
INSERT INTO `sys_menu` VALUES (602, 601, '删除', NULL, 'novel:book:remove', 2, NULL, 6, NULL, NULL);
INSERT INTO `sys_menu` VALUES (603, 600, '评论管理', 'novel/bookComment', 'novel:bookComment:bookComment', 1, 'fa', 10, NULL, NULL);
INSERT INTO `sys_menu` VALUES (604, 603, '删除', NULL, 'novel:bookComment:remove', 2, NULL, 6, NULL, NULL);
INSERT INTO `sys_menu` VALUES (605, 601, '新增', '', 'novel:book:add', 2, '', NULL, NULL, NULL);
INSERT INTO `sys_menu` VALUES (606, 601, '批量删除', '', 'novel:book:batchRemove', 2, '', NULL, NULL, NULL);
...
CREATE TABLE `sys_role_data_perm`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 95 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色与数据权限对应关系' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_role_data_perm` VALUES (87, 1, 214);
INSERT INTO `sys_role_data_perm` VALUES (88, 1, 213);
INSERT INTO `sys_role_data_perm` VALUES (89, 1, 212);
INSERT INTO `sys_role_data_perm` VALUES (90, 1, 211);
INSERT INTO `sys_role_data_perm` VALUES (91, 1, 210);
INSERT INTO `sys_role_data_perm` VALUES (92, 1, 1681861071342252032);
INSERT INTO `sys_role_data_perm` VALUES (93, 1, -1);
INSERT INTO `sys_role_data_perm` VALUES (94, 1, 1681861070230761472);
...
CREATE TABLE `sys_role_menu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5125 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色与菜单对应关系' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_role_menu` VALUES (5026, 1, 604);
INSERT INTO `sys_role_menu` VALUES (5027, 1, 606);
INSERT INTO `sys_role_menu` VALUES (5028, 1, 605);
INSERT INTO `sys_role_menu` VALUES (5029, 1, 602);
INSERT INTO `sys_role_menu` VALUES (5030, 1, 501);
INSERT INTO `sys_role_menu` VALUES (5031, 1, 410);
INSERT INTO `sys_role_menu` VALUES (5032, 1, 401);
INSERT INTO `sys_role_menu` VALUES (5033, 1, 325);
INSERT INTO `sys_role_menu` VALUES (5034, 1, 324);
INSERT INTO `sys_role_menu` VALUES (5035, 1, 323);
INSERT INTO `sys_role_menu` VALUES (5036, 1, 322);
INSERT INTO `sys_role_menu` VALUES (5037, 1, 321);
INSERT INTO `sys_role_menu` VALUES (5038, 1, 315);
INSERT INTO `sys_role_menu` VALUES (5039, 1, 314);
INSERT INTO `sys_role_menu` VALUES (5040, 1, 313);
INSERT INTO `sys_role_menu` VALUES (5041, 1, 312);
INSERT INTO `sys_role_menu` VALUES (5042, 1, 311);
INSERT INTO `sys_role_menu` VALUES (5043, 1, 305);
INSERT INTO `sys_role_menu` VALUES (5044, 1, 246);
INSERT INTO `sys_role_menu` VALUES (5045, 1, 245);
INSERT INTO `sys_role_menu` VALUES (5046, 1, 244);
INSERT INTO `sys_role_menu` VALUES (5047, 1, 243);
INSERT INTO `sys_role_menu` VALUES (5048, 1, 242);
INSERT INTO `sys_role_menu` VALUES (5049, 1, 240);
INSERT INTO `sys_role_menu` VALUES (5050, 1, 239);
INSERT INTO `sys_role_menu` VALUES (5051, 1, 238);
INSERT INTO `sys_role_menu` VALUES (5052, 1, 237);
INSERT INTO `sys_role_menu` VALUES (5053, 1, 236);
INSERT INTO `sys_role_menu` VALUES (5054, 1, 233);
INSERT INTO `sys_role_menu` VALUES (5055, 1, 232);
INSERT INTO `sys_role_menu` VALUES (5056, 1, 231);
INSERT INTO `sys_role_menu` VALUES (5057, 1, 230);
INSERT INTO `sys_role_menu` VALUES (5058, 1, 229);
INSERT INTO `sys_role_menu` VALUES (5059, 1, 227);
INSERT INTO `sys_role_menu` VALUES (5060, 1, 226);
INSERT INTO `sys_role_menu` VALUES (5061, 1, 225);
INSERT INTO `sys_role_menu` VALUES (5062, 1, 224);
INSERT INTO `sys_role_menu` VALUES (5063, 1, 223);
INSERT INTO `sys_role_menu` VALUES (5064, 1, 92);
INSERT INTO `sys_role_menu` VALUES (5065, 1, 57);
INSERT INTO `sys_role_menu` VALUES (5066, 1, 30);
INSERT INTO `sys_role_menu` VALUES (5067, 1, 29);
INSERT INTO `sys_role_menu` VALUES (5068, 1, 28);
INSERT INTO `sys_role_menu` VALUES (5069, 1, 104);
INSERT INTO `sys_role_menu` VALUES (5070, 1, 48);
INSERT INTO `sys_role_menu` VALUES (5071, 1, 214);
INSERT INTO `sys_role_menu` VALUES (5072, 1, 213);
INSERT INTO `sys_role_menu` VALUES (5073, 1, 212);
INSERT INTO `sys_role_menu` VALUES (5074, 1, 211);
INSERT INTO `sys_role_menu` VALUES (5075, 1, 210);
INSERT INTO `sys_role_menu` VALUES (5076, 1, 76);
INSERT INTO `sys_role_menu` VALUES (5077, 1, 75);
INSERT INTO `sys_role_menu` VALUES (5078, 1, 74);
INSERT INTO `sys_role_menu` VALUES (5079, 1, 62);
INSERT INTO `sys_role_menu` VALUES (5080, 1, 56);
INSERT INTO `sys_role_menu` VALUES (5081, 1, 55);
INSERT INTO `sys_role_menu` VALUES (5082, 1, 15);
INSERT INTO `sys_role_menu` VALUES (5083, 1, 26);
INSERT INTO `sys_role_menu` VALUES (5084, 1, 25);
INSERT INTO `sys_role_menu` VALUES (5085, 1, 24);
INSERT INTO `sys_role_menu` VALUES (5086, 1, 14);
INSERT INTO `sys_role_menu` VALUES (5087, 1, 13);
INSERT INTO `sys_role_menu` VALUES (5088, 1, 12);
INSERT INTO `sys_role_menu` VALUES (5089, 1, 61);
INSERT INTO `sys_role_menu` VALUES (5090, 1, 22);
INSERT INTO `sys_role_menu` VALUES (5091, 1, 21);
INSERT INTO `sys_role_menu` VALUES (5092, 1, 20);
INSERT INTO `sys_role_menu` VALUES (5093, 1, 83);
INSERT INTO `sys_role_menu` VALUES (5094, 1, 81);
INSERT INTO `sys_role_menu` VALUES (5095, 1, 80);
INSERT INTO `sys_role_menu` VALUES (5096, 1, 79);
INSERT INTO `sys_role_menu` VALUES (5097, 1, 71);
INSERT INTO `sys_role_menu` VALUES (5098, 1, 603);
INSERT INTO `sys_role_menu` VALUES (5099, 1, 500);
INSERT INTO `sys_role_menu` VALUES (5100, 1, 400);
INSERT INTO `sys_role_menu` VALUES (5101, 1, 320);
INSERT INTO `sys_role_menu` VALUES (5102, 1, 310);
INSERT INTO `sys_role_menu` VALUES (5103, 1, 301);
INSERT INTO `sys_role_menu` VALUES (5104, 1, 300);
INSERT INTO `sys_role_menu` VALUES (5105, 1, 241);
INSERT INTO `sys_role_menu` VALUES (5106, 1, 235);
INSERT INTO `sys_role_menu` VALUES (5107, 1, 234);
INSERT INTO `sys_role_menu` VALUES (5108, 1, 228);
INSERT INTO `sys_role_menu` VALUES (5109, 1, 222);
INSERT INTO `sys_role_menu` VALUES (5110, 1, 221);
INSERT INTO `sys_role_menu` VALUES (5111, 1, 27);
INSERT INTO `sys_role_menu` VALUES (5112, 1, 91);
INSERT INTO `sys_role_menu` VALUES (5113, 1, 77);
INSERT INTO `sys_role_menu` VALUES (5114, 1, 209);
INSERT INTO `sys_role_menu` VALUES (5115, 1, 73);
INSERT INTO `sys_role_menu` VALUES (5116, 1, 7);
INSERT INTO `sys_role_menu` VALUES (5117, 1, 6);
INSERT INTO `sys_role_menu` VALUES (5118, 1, 2);
INSERT INTO `sys_role_menu` VALUES (5119, 1, 3);
INSERT INTO `sys_role_menu` VALUES (5120, 1, 78);
INSERT INTO `sys_role_menu` VALUES (5121, 1, 1);
INSERT INTO `sys_role_menu` VALUES (5122, 1, -1);
INSERT INTO `sys_role_menu` VALUES (5123, 1, 600);
INSERT INTO `sys_role_menu` VALUES (5124, 1, 601);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'admin', '超级管理员', 'd633268afedf209e1e4ea0f5f43228a8', 14, 'admin@example.com', '17699999999', 1, 1, '2017-08-15 21:40:39', '2017-08-15 21:41:00', 97, '2017-12-14 00:00:00', 148, 'ccc', '122;121;', '北京市', '北京市市辖区', '东城区');
...
CREATE TABLE `user`  (
  ...
  `email` varchar(45) DEFAULT NULL COMMENT '个人邮箱',
  `password` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '登录密码',
  `nick_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '昵称',
  `user_photo` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '用户头像',
  `user_sex` tinyint(1) NULL DEFAULT NULL COMMENT '用户性别，0：男，1：女',
  `account_balance` bigint(20) NOT NULL DEFAULT 0 COMMENT '账户余额',
  `status` tinyint(1) NOT NULL DEFAULT 0 COMMENT '用户状态，0：正常',
  `is_member` tinyint(1) DEFAULT '0' COMMENT '是否充值会员，0：未充值，1：充值会员',
  `member_validity_time` datetime DEFAULT NULL COMMENT '充值会员截止时间',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `update_time` datetime NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `key_uq_username`(`username`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1681952053513478145 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1255060328322027520, '13560421324', 'e10adc3949ba59abbe56e057f20f883e', '13560421324', '/localPic/2023/07/20/c0d4c3db11dd48c7a0ef675ec27927bb.jpg', 1, 70998, 0, '2020-04-28 17:04:35', '2023-07-20 14:53:36');
...
INSERT INTO `user` VALUES (1681866976364371968, '15755581234', 'e10adc3949ba59abbe56e057f20f883e', '15755581234', NULL, NULL, 0, 0, '2023-07-20 11:21:49', '2023-07-20 11:21:49');
INSERT INTO `user` VALUES (1681952053513478144, '13560421325', 'e10adc3949ba59abbe56e057f20f883e', '13560421325', NULL, NULL, 49998, 0, '2023-07-20 16:59:53', '2023-07-20 16:59:53');
...
CREATE TABLE `user_bookshelf`  (
  ...
  `user_id` bigint(20) NOT NULL COMMENT '用户ID',
  `book_id` bigint(20) NOT NULL COMMENT '小说ID',
  `pre_content_id` bigint(20) NULL DEFAULT NULL COMMENT '上一次阅读的章节内容表ID',
  `create_time` datetime NULL DEFAULT NULL,
  `update_time` datetime NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `key_uq_userid_bookid`(`user_id`, `book_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 46 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户书架表' ROW_FORMAT = Dynamic;
...
INSERT INTO `user_bookshelf` VALUES (42, 1255060328322027520, 1262260513468559361, 1681921125672071168, '2023-07-19 15:53:03', '2023-07-20 14:57:22');
INSERT INTO `user_bookshelf` VALUES (43, 1681866976364371968, 1262260513468559361, 1681570233898815488, '2023-07-20 11:55:02', '2023-07-20 11:55:06');
INSERT INTO `user_bookshelf` VALUES (44, 1255060328322027520, 1262260513468559362, 1681869263635783680, '2023-07-20 14:42:00', '2023-07-20 14:43:45');
INSERT INTO `user_bookshelf` VALUES (45, 1681952053513478144, 1262260513468559361, 1681921125672071168, '2023-07-20 17:05:04', '2023-07-20 17:07:02');
...
CREATE TABLE `user_buy_record`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `user_id` bigint(20) NOT NULL COMMENT '用户ID',
  `book_id` bigint(20) NULL DEFAULT NULL COMMENT '购买的小说ID',
  `book_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '购买的小说名',
  `book_index_id` bigint(20) NULL DEFAULT NULL COMMENT '购买的章节ID',
  `book_index_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '购买的章节名',
  `buy_amount` int(11) NULL DEFAULT NULL COMMENT '购买使用的屋币数量',
  `create_time` datetime NULL DEFAULT NULL COMMENT '购买时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `key_userId_indexId`(`user_id`, `book_index_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户消费记录表' ROW_FORMAT = Dynamic;
...
INSERT INTO `user_buy_record` VALUES (3, 1255060328322027520, 1262260513468559361, '斗破苍穹', 1681921125672071168, '第二章 斗气大陆', 2, '2023-07-20 14:57:21');
INSERT INTO `user_buy_record` VALUES (4, 1681952053513478144, 1262260513468559361, '斗破苍穹', 1681921125672071168, '第二章 斗气大陆', 2, '2023-07-20 17:07:02');
...
CREATE TABLE `user_feedback`  (
  ...
  `user_id` bigint(20) NULL DEFAULT NULL COMMENT '用户id',
  `content` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '反馈内容',
  `create_time` datetime NULL DEFAULT NULL COMMENT '反馈时间',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `user_feedback` VALUES (9, 1681952053513478144, '你好你好你好', '2023-07-20 17:08:57');
...
CREATE TABLE `user_read_history`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `key_uq_userid_bookid`(`user_id`, `book_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 137 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户阅读记录表' ROW_FORMAT = Dynamic;
...
INSERT INTO `user_read_history` VALUES (123, 1681866976364371968, 1262260513468559361, 1681570233898815488, '2023-07-20 11:55:06', '2023-07-20 11:55:06');
INSERT INTO `user_read_history` VALUES (130, 1255060328322027520, 1262260513468559362, 1681869263635783680, '2023-07-20 14:43:45', '2023-07-20 14:43:45');
INSERT INTO `user_read_history` VALUES (132, 1255060328322027520, 1262260513468559361, 1681921125672071168, '2023-07-20 14:57:22', '2023-07-20 14:57:22');
INSERT INTO `user_read_history` VALUES (136, 1681952053513478144, 1262260513468559361, 1681921125672071168, '2023-07-20 17:07:02', '2023-07-20 17:07:02');
...
CREATE TABLE `website_info`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '网站名',
  `domain` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '网站域名',
  `keyword` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'SEO关键词',
  `description` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '网站描述',
  `qq` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '站长QQ',
  `logo` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '网站logo图片（默认）',
  `logo_dark` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '网站logo图片（深色）',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `create_user_id` bigint(20) NULL DEFAULT NULL COMMENT '创建人ID',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `update_user_id` bigint(20) NULL DEFAULT NULL COMMENT '更新人ID',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '网站信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of website_info
-- ----------------------------
INSERT INTO `website_info` VALUES (1, '爱看小说', 'www.ainovel.com', '爱看小说,小说,小说CMS,原创文学系统,开源小说系统,免费小说建站程序', '爱看小说是一个多端（PC、WAP）阅读、功能完善的原创文学CMS系统，由前台门户系统、作家后台管理系统、平台后台管理系统、爬虫管理系统等多个子系统构成，支持会员充值、订阅模式、新闻发布和实时统计报表等功能，新书自动入库，老书自动更新。', '931708230', 'https://ynwcode.gitee.io/resource/images/logo/logo.png', 'https://ynwcode.gitee.io/resource/images/logo/logo_white.png', NULL, NULL, NULL, NULL);
